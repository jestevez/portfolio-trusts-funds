...
/**
 * Class generated by AS/400 CRTCLASS command from APOFIFFM physical file
 * definition.
 * 
* File level identifier is 1140131150304. Record format level identifier is
 * 3014D97A41BAA.
 */
public class APOFIFFMMessage extends MessageRecord {
    ...
    final static String fid = "1140131150304";
    final static String rid = "3014D97A41BAA";
    final static String fmtname = "APOFIFFM";
    ...
    /**
     * Constructor for APOFIFFMMessage.
     */
    public APOFIFFMMessage() {
        createFields();
        initialize();
    }
