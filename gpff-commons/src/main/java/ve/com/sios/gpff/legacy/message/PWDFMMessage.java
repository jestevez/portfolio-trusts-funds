...
/**
 * Class generated by AS/400 CRTCLASS command from PWDFM physical file
 * definition.
 * 
* File level identifier is 1140215080607. Record format level identifier is
 * 436DDDCE23A82.
 */
public class PWDFMMessage extends MessageRecord {
    ...
    final static String fid = "1140215080607";
    final static String rid = "436DDDCE23A82";
    final static String fmtname = "PWDFM";
