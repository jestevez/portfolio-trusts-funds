...
/**
* Class generated by AS/400 CRTCLASS command from RELTITFM physical file definition.
* 
* File level identifier is 1140216175638.
* Record format level identifier is 2D88C92155F2D.
*/

public class RELTITFMMessage extends MessageRecord
{
  ...
  final static String fid = "1140216175638";
  final static String rid = "2D88C92155F2D";
  final static String fmtname = "RELTITFM";
  ...
  /**
  * Constructor for RELTITFMMessage.
  */
  public RELTITFMMessage()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    fields[12] = fieldINVCLI =
    new DecimalField(message, HEADERSIZE + 186, 8, 0, "INVCLI");
    fields[13] = fieldNOMCLI =
    new CharacterField(message, HEADERSIZE + 194, 40, "NOMCLI");
    fields[14] = fieldINVNOP =
    new DecimalField(message, HEADERSIZE + 234, 11, 0, "INVNOP");
    fields[15] = fieldSFTIT =
    new DecimalField(message, HEADERSIZE + 245, 11, 0, "SFTIT");
    fields[16] = fieldSFIMP =
    new DecimalField(message, HEADERSIZE + 256, 17, 2, "SFIMP");
    fields[17] = fieldINVVNO =
    new DecimalField(message, HEADERSIZE + 273, 17, 2, "INVVNO");
    fields[18] = fieldTOTIMP =
    new DecimalField(message, HEADERSIZE + 290, 15, 2, "TOTIMP");
    fields[19] = fieldRTITIT =
    new DecimalField(message, HEADERSIZE + 305, 11, 0, "RTITIT");
    fields[20] = fieldRTIIMP =
    new DecimalField(message, HEADERSIZE + 316, 17, 2, "RTIIMP");
    fields[21] = fieldRESTO =
    new DecimalField(message, HEADERSIZE + 333, 15, 2, "RESTO");
    fields[22] = fieldINVINT =
    new DecimalField(message, HEADERSIZE + 348, 8, 0, "INVINT");
    fields[23] = fieldSEL =
    new CharacterField(message, HEADERSIZE + 356, 1, "SEL");
    fields[24] = fieldINVVAL =
    new CharacterField(message, HEADERSIZE + 357, 12, "INVVAL");
    fields[25] = fieldINVVTO =
    new DecimalField(message, HEADERSIZE + 369, 7, 0, "INVVTO");
    fields[26] = fieldINVPOP =
    new DecimalField(message, HEADERSIZE + 376, 11, 6, "INVPOP");
