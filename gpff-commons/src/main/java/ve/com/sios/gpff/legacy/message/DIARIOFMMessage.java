...
/**
 * Class generated by AS/400 CRTCLASS command from DIARIOFM physical file
 * definition.
 * 
* File level identifier is 1140223215040. Record format level identifier is
 * 3A453FEC6E6D9.
 */
public class DIARIOFMMessage extends MessageRecord {
    ...
    final static String fid = "1140223215040";
    final static String rid = "3A453FEC6E6D9";
    final static String fmtname = "DIARIOFM";
    ...
    /**
     * Constructor for DIARIOFMMessage.
     */
    public DIARIOFMMessage() {
        createFields();
        initialize();
    }
    ...
    protected void createFields() {
        ...
        fields[9] = fieldDESDE
                = new DecimalField(message, HEADERSIZE + 161, 7, 0, "DESDE");
        fields[10] = fieldHASTA
                = new DecimalField(message, HEADERSIZE + 168, 7, 0, "HASTA");
