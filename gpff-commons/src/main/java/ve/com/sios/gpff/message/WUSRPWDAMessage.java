...
/**
* Class generated by AS/400 CRTCLASS command from WUSRPWDA physical file definition.
* 
* File level identifier is 1121122144557.
* Record format level identifier is 4C666926E1D7B.
*/
...
USER       CHAR           10      10       554        Ambos    USUARIO
NOMBRE     CHAR           45      45       564        Ambos    NOMBRE USUARIO
IDENT      CHAR           12      12       609        Ambos    IDENTIFICACION

 */

public class WUSRPWDAMessage extends MessageRecord
{
  ...
  final static String fid = "1121122144557";
  final static String rid = "4C666926E1D7B";
  final static String fmtname = "WUSRPWDA";
  ...
  private CharacterField fieldUSER = null;
  private CharacterField fieldNOMBRE = null;
  private CharacterField fieldIDENT = null;

  /**
  * Constructor for WUSRPWDAMessage.
  */
  public WUSRPWDAMessage()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    fields[22] = fieldUSER =
    new CharacterField(message, HEADERSIZE + 562, 10, "USER");
    fields[23] = fieldNOMBRE =
    new CharacterField(message, HEADERSIZE + 572, 45, "NOMBRE");
    fields[24] = fieldIDENT =
    new CharacterField(message, HEADERSIZE + 617, 12, "IDENT");
  ...
  */
  ...
  /**
  * Set field USER using a String value.
  */
  public void setUSER(String newvalue)
  {
    fieldUSER.setString(newvalue);
  }

  /**
  * Get value of field USER as a String.
  */
  public String getUSER()
  {
    return fieldUSER.getString();
  }
  ...
  */
  ...
  /**
  * Set field IDENT using a String value.
  */
  public void setIDENT(String newvalue)
  {
    fieldIDENT.setString(newvalue);
  }

  /**
  * Get value of field IDENT as a String.
  */
  public String getIDENT()
  {
    return fieldIDENT.getString();
  }
