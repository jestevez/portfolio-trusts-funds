...
/**
 * Class generated by AS/400 CRTCLASS command from RECGRTFM physical file
 * definition.
 * 
* File level identifier is 1140322133010. Record format level identifier is
 * 45BF61D14EDC4.
 */
public class RECGRTFMMessage extends MessageRecord {
    ...
    final static String fid = "1140322133010";
    final static String rid = "45BF61D14EDC4";
    final static String fmtname = "RECGRTFM";
    ...
    /**
     * Constructor for RECGRTFMMessage.
     */
    public RECGRTFMMessage() {
        createFields();
        initialize();
    }
    ...
    protected void createFields() {
        ...
        fields[10] = fieldREGCUR
                = new CharacterField(message, HEADERSIZE + 173, 10, "REGCUR");
        fields[11] = fieldCAMCUR
                = new CharacterField(message, HEADERSIZE + 183, 10, "CAMCUR");
        fields[12] = fieldPOSCUR
                = new DecimalField(message, HEADERSIZE + 193, 5, 0, "POSCUR");
