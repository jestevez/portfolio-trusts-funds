...
/**
 * Class generated by AS/400 CRTCLASS command from CTLCON2FM physical file
 * definition.
 * 
* File level identifier is 1140315131917. Record format level identifier is
 * 509FB3DA3CB27.
 */
public class CTLCON2FMMessage extends MessageRecord {
    ...
    final static String fid = "1140315131917";
    final static String rid = "509FB3DA3CB27";
    final static String fmtname = "CTLCON2FM";
    ...
    /**
     * Constructor for CTLCON2FMMessage.
     */
    public CTLCON2FMMessage() {
        createFields();
        initialize();
    }
