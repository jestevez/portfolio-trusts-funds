...
/**
 * Class generated by AS/400 CRTCLASS command from MOVCTAFM physical file
 * definition.
 * 
* File level identifier is 1140315074942. Record format level identifier is
 * 538893C6D3C0B.
 */
public class MOVCTAFMMessage extends MessageRecord {
    ...
    final static String fid = "1140315074942";
    final static String rid = "538893C6D3C0B";
    final static String fmtname = "MOVCTAFM";
    ...
    private DecimalField fieldNCUENT = null;

    /**
     * Constructor for MOVCTAFMMessage.
     */
    public MOVCTAFMMessage() {
        createFields();
        initialize();
    }
    ...
    protected void createFields() {
        ...
        fields[14] = fieldNCUENT
                = new DecimalField(message, HEADERSIZE + 223, 4, 0, "NCUENT");
    ...
    /**
     * Set numeric field NCUENT using a BigDecimal value.
     */
    public void setNCUENT(BigDecimal newvalue) {
        fieldNCUENT.setBigDecimal(newvalue);
    }

    /**
     * Return value of numeric field NCUENT as a BigDecimal.
     */
    public BigDecimal getBigDecimalNCUENT() {
        return fieldNCUENT.getBigDecimal();
    }
