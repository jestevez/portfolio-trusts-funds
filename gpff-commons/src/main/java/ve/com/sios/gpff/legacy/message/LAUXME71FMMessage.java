...
/**
 * Class generated by AS/400 CRTCLASS command from LAUXME71FM physical file
 * definition.
 * 
* File level identifier is 1140313213737. Record format level identifier is
 * 480BCC954C5DB.
 */

public class LAUXME71FMMessage extends MessageRecord {
    ...
    final static String fid = "1140313213737";
    final static String rid = "480BCC954C5DB";
    final static String fmtname = "LAUXME71FM";
    ...
    protected void createFields() {
        ...
        fields[14] = fieldCUENTAX
                = new CharacterField(message, HEADERSIZE + 193, 12, "CUENTAX");
        fields[15] = fieldCATEGO
                = new DecimalField(message, HEADERSIZE + 205, 3, 0, "CATEGO");
        fields[16] = fieldDESCAT
                = new CharacterField(message, HEADERSIZE + 208, 30, "DESCAT");
        fields[17] = fieldFINIQUI
                = new CharacterField(message, HEADERSIZE + 238, 1, "FINIQUI");
    ...
    /**
     * Set field CUENTAX using a String value.
     */
    public void setCUENTAX(String newvalue) {
        fieldCUENTAX.setString(newvalue);
    }

    /**
     * Get value of field CUENTAX as a String.
     */
    public String getCUENTAX() {
        return fieldCUENTAX.getString();
    }
