...
/**
 * Class generated by AS/400 CRTCLASS command from LISINEMFM physical file
 * definition.
 * 
* File level identifier is 1140223213502. Record format level identifier is
 * 4228BD0473976.
 */
public class LISINEMFMMessage extends MessageRecord {
    ...
    final static String fid = "1140223213502";
    final static String rid = "4228BD0473976";
    final static String fmtname = "LISINEMFM";
    ...
    /**
     * Constructor for LISINEMFMMessage.
     */
    public LISINEMFMMessage() {
        createFields();
        initialize();
    }
    ...
    protected void createFields() {
        ...
        fields[9] = fieldCEDULA
                = new CharacterField(message, HEADERSIZE + 161, 12, "CEDULA");
        fields[10] = fieldAREDES
                = new CharacterField(message, HEADERSIZE + 173, 4, "AREDES");
        fields[11] = fieldAREHAS
                = new CharacterField(message, HEADERSIZE + 177, 4, "AREHAS");
        fields[12] = fieldFECHAS
                = new DecimalField(message, HEADERSIZE + 181, 7, 0, "FECHAS");
