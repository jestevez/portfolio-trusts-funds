...
/**
 * Class generated by AS/400 CRTCLASS command from CAFVVAFM physical file
 * definition.
 * 
* File level identifier is 1140216173102. Record format level identifier is
 * 48BF64675DE75.
 */

public class CAFVVAFMMessage extends MessageRecord {
    ...
    final static String fid = "1140216173102";
    final static String rid = "48BF64675DE75";
    final static String fmtname = "CAFVVAFM";
    ...
    private DecimalField fieldFEANT = null;
    private DecimalField fieldFENUE = null;

    /**
     * Constructor for CAFVVAFMMessage.
     */
    public CAFVVAFMMessage() {
        createFields();
        initialize();
    }
    ...
    protected void createFields() {
        ...
        fields[12] = fieldVALOR
                = new CharacterField(message, HEADERSIZE + 186, 12, "VALOR");
        fields[13] = fieldVLONOM
                = new CharacterField(message, HEADERSIZE + 198, 40, "VLONOM");
        fields[14] = fieldFEANT
                = new DecimalField(message, HEADERSIZE + 238, 7, 0, "FEANT");
        fields[15] = fieldFENUE
                = new DecimalField(message, HEADERSIZE + 245, 7, 0, "FENUE");
    ...
    /**
     * Set field FEANT using a String value.
     */
    public void setFEANT(String newvalue) {
        fieldFEANT.setString(newvalue);
    }

    /**
     * Get value of field FEANT as a String.
     */
    public String getFEANT() {
        return fieldFEANT.getString();
    }

    /**
     * Set numeric field FEANT using a BigDecimal value.
     */
    public void setFEANT(BigDecimal newvalue) {
        fieldFEANT.setBigDecimal(newvalue);
    }

    /**
     * Return value of numeric field FEANT as a BigDecimal.
     */
    public BigDecimal getBigDecimalFEANT() {
        return fieldFEANT.getBigDecimal();
    }

    /**
     * Set field FENUE using a String value.
     */
    public void setFENUE(String newvalue) {
        fieldFENUE.setString(newvalue);
    }

    /**
     * Get value of field FENUE as a String.
     */
    public String getFENUE() {
        return fieldFENUE.getString();
    }

    /**
     * Set numeric field FENUE using a BigDecimal value.
     */
    public void setFENUE(BigDecimal newvalue) {
        fieldFENUE.setBigDecimal(newvalue);
    }

    /**
     * Return value of numeric field FENUE as a BigDecimal.
     */
    public BigDecimal getBigDecimalFENUE() {
        return fieldFENUE.getBigDecimal();
    }
