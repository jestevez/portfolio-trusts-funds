...
/**
 * Class generated by AS/400 CRTCLASS command from LICOFIFM physical file
 * definition.
 * 
* File level identifier is 1140315140057. Record format level identifier is
 * 51779235C3309.
 */
public class LICOFIFMMessage extends MessageRecord {
    ...
    final static String fid = "1140315140057";
    final static String rid = "51779235C3309";
    final static String fmtname = "LICOFIFM";
    ...
    private DecimalField fieldFECFII = null;
    private CharacterField fieldTIPOFI = null;

    /**
     * Constructor for LICOFIFMMessage.
     */
    public LICOFIFMMessage() {
        createFields();
        initialize();
    }
    ...
    protected void createFields() {
        ...
        fields[13] = fieldFECFII
                = new DecimalField(message, HEADERSIZE + 216, 7, 0, "FECFII");
        fields[14] = fieldTIPOFI
                = new CharacterField(message, HEADERSIZE + 223, 1, "TIPOFI");
    ...
    /**
     * Set field FECFII using a String value.
     */
    public void setFECFII(String newvalue) {
        fieldFECFII.setString(newvalue);
    }

    /**
     * Get value of field FECFII as a String.
     */
    public String getFECFII() {
        return fieldFECFII.getString();
    }

    /**
     * Set numeric field FECFII using a BigDecimal value.
     */
    public void setFECFII(BigDecimal newvalue) {
        fieldFECFII.setBigDecimal(newvalue);
    }

    /**
     * Return value of numeric field FECFII as a BigDecimal.
     */
    public BigDecimal getBigDecimalFECFII() {
        return fieldFECFII.getBigDecimal();
    }

    /**
     * Set field TIPOFI using a String value.
     */
    public void setTIPOFI(String newvalue) {
        fieldTIPOFI.setString(newvalue);
    }

    /**
     * Get value of field TIPOFI as a String.
     */
    public String getTIPOFI() {
        return fieldTIPOFI.getString();
    }
