...
/**
 * Class generated by AS/400 CRTCLASS command from LISAUMFM physical file
 * definition.
 * 
* File level identifier is 1140202171347. Record format level identifier is
 * 48B89CFDDA0BD.
 */
public class LISAUMFMMessage extends MessageRecord {
    ...
    final static String fid = "1140202171347";
    final static String rid = "48B89CFDDA0BD";
    final static String fmtname = "LISAUMFM";
    ...
    private DecimalField fieldNCUENTA = null;

    /**
     * Constructor for LISAUMFMMessage.
     */
    public LISAUMFMMessage() {
        createFields();
        initialize();
    }
    ...
    protected void createFields() {
        ...
        fields[9] = fieldED1
                = new CharacterField(message, HEADERSIZE + 161, 4, "ED1");
        fields[10] = fieldED2
                = new CharacterField(message, HEADERSIZE + 165, 4, "ED2");
        fields[11] = fieldFECHAD
                = new DecimalField(message, HEADERSIZE + 169, 7, 0, "FECHAD");
        fields[12] = fieldFECFFF
                = new DecimalField(message, HEADERSIZE + 176, 7, 0, "FECFFF");
        fields[13] = fieldNCUENTA
                = new DecimalField(message, HEADERSIZE + 183, 15, 0, "NCUENTA");
    ...
    /**
     * Set field NCUENTA using a String value.
     */
    public void setNCUENTA(String newvalue) {
        fieldNCUENTA.setString(newvalue);
    }

    /**
     * Get value of field NCUENTA as a String.
     */
    public String getNCUENTA() {
        return fieldNCUENTA.getString();
    }

    /**
     * Set numeric field NCUENTA using a BigDecimal value.
     */
    public void setNCUENTA(BigDecimal newvalue) {
        fieldNCUENTA.setBigDecimal(newvalue);
    }

    /**
     * Return value of numeric field NCUENTA as a BigDecimal.
     */
    public BigDecimal getBigDecimalNCUENTA() {
        return fieldNCUENTA.getBigDecimal();
    }
