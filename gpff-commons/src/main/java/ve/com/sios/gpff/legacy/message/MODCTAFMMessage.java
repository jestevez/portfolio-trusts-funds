...
/**
 * Class generated by AS/400 CRTCLASS command from MODCTAFM physical file
 * definition.
 * 
* File level identifier is 1140315130715. Record format level identifier is
 * 42F43654B10F1.
 */
public class MODCTAFMMessage extends MessageRecord {
    ...
    final static String fid = "1140315130715";
    final static String rid = "42F43654B10F1";
    final static String fmtname = "MODCTAFM";
    ...
    /**
     * Constructor for MODCTAFMMessage.
     */
    public MODCTAFMMessage() {
        createFields();
        initialize();
    }
