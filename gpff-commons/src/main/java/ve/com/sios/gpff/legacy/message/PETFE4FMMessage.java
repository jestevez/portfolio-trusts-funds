...
/**
 * Class generated by AS/400 CRTCLASS command from PETFE4FM physical file
 * definition.
 * 
* File level identifier is 1140315132410. Record format level identifier is
 * 2F05CD05A1FFD.
 */
public class PETFE4FMMessage extends MessageRecord {
    ...
    final static String fid = "1140315132410";
    final static String rid = "2F05CD05A1FFD";
    final static String fmtname = "PETFE4FM";
    ...
    private CharacterField fieldFINI = null;

    /**
     * Constructor for PETFE4FMMessage.
     */
    public PETFE4FMMessage() {
        createFields();
        initialize();
    }
    ...
    protected void createFields() {
        ...
        fields[13] = fieldFINI
                = new CharacterField(message, HEADERSIZE + 183, 1, "FINI");
    ...
    /**
     * Set field FINI using a String value.
     */
    public void setFINI(String newvalue) {
        fieldFINI.setString(newvalue);
    }

    /**
     * Get value of field FINI as a String.
     */
    public String getFINI() {
        return fieldFINI.getString();
    }
