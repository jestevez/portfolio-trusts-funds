...
/**
 * Class generated by AS/400 CRTCLASS command from WTIPUSRA physical file definition.
 * 
 * Mantenimiento de Tipos de Usuarios
 * 
 * File level identifier is 1121217140901. Record format level identifier is
 * 449063E3401F1.
 */
public class WTIPUSRAMessage extends MessageRecord {
...
TIPO       PACKED       2  0       2       554        Ambos    TIPO
TIPDES     CHAR           40      40       556        Ambos    DESCRIPCION
*/
    ...
    final static String fid = "1121217140901";
    final static String rid = "449063E3401F1";
    final static String fmtname = "WTIPUSRA";
    ...
    private DecimalField fieldTIPO = null;
    private CharacterField fieldTIPDES = null;

    /**
     * Constructor for WTIPUSRAMessage.
     */
    public WTIPUSRAMessage() {
        createFields();
        initialize();
    }
    ...
    protected void createFields() {
        ...
        fields[23] = fieldTIPO =
                new DecimalField(message, HEADERSIZE + 572, 3, 0, "TIPO");
        fields[24] = fieldTIPDES =
                new CharacterField(message, HEADERSIZE + 575, 40, "TIPDES");
    ...
    /**
     * Set numeric field TIPO using a BigDecimal value.
     */
    public void setTIPO(BigDecimal newvalue) {
        fieldTIPO.setBigDecimal(newvalue);
    }

    /**
     * Return value of numeric field TIPO as a BigDecimal.
     */
    public BigDecimal getBigDecimalTIPO() {
        return fieldTIPO.getBigDecimal();
    }

    /**
     * Set field TIPDES using a String value.
     */
    public void setTIPDES(String newvalue) {
        fieldTIPDES.setString(newvalue);
    }

    /**
     * Get value of field TIPDES as a String.
     */
    public String getTIPDES() {
        return fieldTIPDES.getString();
    }
}
