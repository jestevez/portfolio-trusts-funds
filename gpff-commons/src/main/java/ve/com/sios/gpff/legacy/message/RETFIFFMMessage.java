...
/**
* Class generated by AS/400 CRTCLASS command from RETFIFFM physical file definition.
* 
* File level identifier is 1140213210206.
* Record format level identifier is 4E6CC610EDDCC.
*/

public class RETFIFFMMessage extends MessageRecord
{
  ...
  final static String fid = "1140213210206";
  final static String rid = "4E6CC610EDDCC";
  final static String fmtname = "RETFIFFM";
  ...
  /**
  * Constructor for RETFIFFMMessage.
  */
  public RETFIFFMMessage()
  {
    createFields();
    initialize();
  }
