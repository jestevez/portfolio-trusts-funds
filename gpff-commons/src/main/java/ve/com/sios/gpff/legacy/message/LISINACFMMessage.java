...
/**
 * Class generated by AS/400 CRTCLASS command from LISINACFM physical file
 * definition.
 * 
* File level identifier is 1140223211927. Record format level identifier is
 * 4638A114D1B67.
 */
public class LISINACFMMessage extends MessageRecord {
    ...
    final static String fid = "1140223211927";
    final static String rid = "4638A114D1B67";
    final static String fmtname = "LISINACFM";
    ...
    protected void createFields() {
        ...
        fields[9] = fieldMODAL
                = new CharacterField(message, HEADERSIZE + 161, 3, "MODAL");
        fields[10] = fieldAREDES
                = new CharacterField(message, HEADERSIZE + 164, 4, "AREDES");
        fields[11] = fieldAREHAS
                = new CharacterField(message, HEADERSIZE + 168, 4, "AREHAS");
        fields[12] = fieldFECHAS
                = new DecimalField(message, HEADERSIZE + 172, 7, 0, "FECHAS");
    ...
    /**
     * Set field MODAL using a String value.
     */
    public void setMODAL(String newvalue) {
        fieldMODAL.setString(newvalue);
    }

    /**
     * Get value of field MODAL as a String.
     */
    public String getMODAL() {
        return fieldMODAL.getString();
    }
