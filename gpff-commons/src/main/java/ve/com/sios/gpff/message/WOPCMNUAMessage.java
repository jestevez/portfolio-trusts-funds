...
/**
* Class generated by AS/400 CRTCLASS command from WOPCMNUA physical file definition.
* 
* File level identifier is 1121220161644.
* Record format level identifier is 3C7BE4FD4323F.
*/

public class WOPCMNUAMessage extends MessageRecord
{
  ...
  final static String fid = "1121220161644";
  final static String rid = "3C7BE4FD4323F";
  final static String fmtname = "WOPCMNUA";
  ...
  private CharacterField fieldOPCNOM = null;
  private CharacterField fieldOPCMOP = null;
  private CharacterField fieldOPCDES = null;

  /**
  * Constructor for WOPCMNUAMessage.
  */
  public WOPCMNUAMessage()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    fields[14] = fieldOPCNOM =
    new CharacterField(message, HEADERSIZE + 572, 10, "OPCNOM");
    fields[15] = fieldOPCMOP =
    new CharacterField(message, HEADERSIZE + 582, 1, "OPCMOP");
    fields[16] = fieldOPCDES =
    new CharacterField(message, HEADERSIZE + 583, 30, "OPCDES");
  ...
  */
  ...
  /**
  * Set field OPCNOM using a String value.
  */
  public void setOPCNOM(String newvalue)
  {
    fieldOPCNOM.setString(newvalue);
  }

  /**
  * Get value of field OPCNOM as a String.
  */
  public String getOPCNOM()
  {
    return fieldOPCNOM.getString();
  }

  /**
  * Set field OPCMOP using a String value.
  */
  public void setOPCMOP(String newvalue)
  {
    fieldOPCMOP.setString(newvalue);
  }

  /**
  * Get value of field OPCMOP as a String.
  */
  public String getOPCMOP()
  {
    return fieldOPCMOP.getString();
  }

  /**
  * Set field OPCDES using a String value.
  */
  public void setOPCDES(String newvalue)
  {
    fieldOPCDES.setString(newvalue);
  }

  /**
  * Get value of field OPCDES as a String.
  */
  public String getOPCDES()
  {
    return fieldOPCDES.getString();
  }
