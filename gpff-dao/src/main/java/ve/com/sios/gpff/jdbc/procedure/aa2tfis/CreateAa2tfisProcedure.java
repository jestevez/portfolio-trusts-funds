...
/**
 * The Class CreateAa2tfisProcedure.
 *
 ...
 */
@Service
public class CreateAa2tfisProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateAa2tfis";

    /**
     * Instantiates a new creates the aa 2 tfis procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateAa2tfisProcedure(DataSource dataSource) {
