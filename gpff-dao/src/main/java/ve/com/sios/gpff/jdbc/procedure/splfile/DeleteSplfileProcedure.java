...
/**
 * The Class DeleteSplfileProcedure.
 *
 ...
 */
@Service
public class DeleteSplfileProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procDeleteSplfile";

    /**
     * Instantiates a new delete splfile procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public DeleteSplfileProcedure(DataSource dataSource) {
