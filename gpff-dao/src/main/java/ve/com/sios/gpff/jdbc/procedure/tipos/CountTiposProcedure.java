 ...
 */
@Service
public class CountTiposProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountTipos";

    /**
     * Instantiates a new count tipos procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountTiposProcedure(DataSource dataSource) {
