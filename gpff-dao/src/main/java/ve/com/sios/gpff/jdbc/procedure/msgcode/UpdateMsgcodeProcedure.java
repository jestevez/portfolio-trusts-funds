...
/**
 * The Class UpdateMsgcodeProcedure.
 *
 ...
 */
@Service
public class UpdateMsgcodeProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateMsgcode";

    /**
     * Instantiates a new update msgcode procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateMsgcodeProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Msgcode msgcode, AuthorizationData authorizationData) throws Exception {
