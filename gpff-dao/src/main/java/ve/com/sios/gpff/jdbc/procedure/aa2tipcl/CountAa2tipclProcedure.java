...
/**
 * The Class CountAa2tipclProcedure.
 *
 ...
 */
@Service
public class CountAa2tipclProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountAa2tipcl";

    /**
     * Instantiates a new count aa 2 tipcl procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountAa2tipclProcedure(DataSource dataSource) {
