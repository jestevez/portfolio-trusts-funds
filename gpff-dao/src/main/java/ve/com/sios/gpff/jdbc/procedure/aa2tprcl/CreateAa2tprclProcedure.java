...
/**
 * The Class CreateAa2tprclProcedure.
 *
 ...
 */
@Service
public class CreateAa2tprclProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateAa2tprcl";

    /**
     * Instantiates a new creates the aa 2 tprcl procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateAa2tprclProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Aa2tprcl aa2tprcl, AuthorizationData authorizationData) throws Exception {
