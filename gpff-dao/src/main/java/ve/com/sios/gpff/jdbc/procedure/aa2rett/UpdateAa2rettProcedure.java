...
/**
 * The Class UpdateAa2rettProcedure.
 *
 ...
 */
@Service
public class UpdateAa2rettProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateAa2rett";

    /**
     * Instantiates a new update aa 2 rett procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateAa2rettProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Aa2rett aa2rett, AuthorizationData authorizationData) throws Exception {
