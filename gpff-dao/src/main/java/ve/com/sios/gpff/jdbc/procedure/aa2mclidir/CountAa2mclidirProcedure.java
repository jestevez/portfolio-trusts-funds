...
/**
 * The Class CountAa2mclidirProcedure.
 *
 ...
 */
@Service
public class CountAa2mclidirProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountAa2mclidir";

    /**
     * Instantiates a new count aa 2 mclidir procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountAa2mclidirProcedure(DataSource dataSource) {
