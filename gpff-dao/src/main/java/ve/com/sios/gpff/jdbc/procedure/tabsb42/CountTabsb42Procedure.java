...
/**
 * The Class CountTabsb42Procedure.
 *
 ...
 */
@Service
public class CountTabsb42Procedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountTabsb42";

    /**
     * Instantiates a new count tabsb 42 procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountTabsb42Procedure(DataSource dataSource) {
