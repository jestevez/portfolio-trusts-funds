 ...
 */
@Service
public class CountAa2traidProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountAa2traid";

    /**
     * Instantiates a new count aa 2 traid procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountAa2traidProcedure(DataSource dataSource) {
