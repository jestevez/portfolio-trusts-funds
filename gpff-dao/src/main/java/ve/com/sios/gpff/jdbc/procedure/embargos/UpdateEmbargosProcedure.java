...
/**
 * The Class UpdateEmbargosProcedure.
 *
 ...
 */
@Service
public class UpdateEmbargosProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateEmbargos";

    /**
     * Instantiates a new update embargos procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateEmbargosProcedure(DataSource dataSource) {
