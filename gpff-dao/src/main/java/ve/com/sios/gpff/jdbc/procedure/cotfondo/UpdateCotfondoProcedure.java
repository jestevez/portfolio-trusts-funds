...
/**
 * The Class UpdateCotfondoProcedure.
 *
 ...
 */
@Service
public class UpdateCotfondoProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateCotfondo";

    /**
     * Instantiates a new update cotfondo procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateCotfondoProcedure(DataSource dataSource) {
