...
/**
 * The Class CountAa2tfisProcedure.
 *
 ...
 */
@Service
public class CountAa2tfisProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountAa2tfis";

    /**
     * Instantiates a new count aa 2 tfis procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountAa2tfisProcedure(DataSource dataSource) {
