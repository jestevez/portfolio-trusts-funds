...
/**
 * The Class CountAa2ttproProcedure.
 *
 ...
 */
@Service
public class CountAa2ttproProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountAa2ttpro";

    /**
     * Instantiates a new count aa 2 ttpro procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountAa2ttproProcedure(DataSource dataSource) {
