...
/**
 * The Class ReadAa2clicoProcedure.
 *
 ...
 */
@Service
public class ReadAa2clicoProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procReadAa2clico";

    /**
     * Instantiates a new read aa 2 clico procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public ReadAa2clicoProcedure(DataSource dataSource) {
        ...
        declareParameter(new SqlReturnResultSet("RS", new Aa2clicoMapper()));
     ...
     */
    public List execute(Aa2clico aa2clico, int firstResult, int maxResults, String sortClause, AuthorizationData authorizationData) throws GpffDaoException {
        ...
        inParams.put("P_ROWID", aa2clico.getRowid());
...
class Aa2clicoMapper implements RowMapper<Aa2clico> {

    public Aa2clico mapRow(ResultSet rs, int i) throws SQLException {
        Aa2clico aa2clico = new Aa2clico();
        aa2clico.setRowid(rs.getLong("ROWID"));
        aa2clico.setClccla(rs.getLong("CLCCLA"));
        aa2clico.setClcctr(rs.getInt("CLCCTR"));
        aa2clico.setClcnom(rs.getString("CLCNOM"));
        aa2clico.setClcape(rs.getString("CLCAPE"));
        aa2clico.setClcap2(rs.getString("CLCAP2"));
        aa2clico.setClcdi1(rs.getString("CLCDI1"));
        aa2clico.setClcdi2(rs.getString("CLCDI2"));
        aa2clico.setClcpos(rs.getString("CLCPOS"));
        aa2clico.setClcpro(rs.getString("CLCPRO"));
        aa2clico.setClcpai(rs.getInt("CLCPAI"));
        aa2clico.setClcpob(rs.getString("CLCPOB"));
        aa2clico.setClccal(rs.getString("CLCCAL"));
        aa2clico.setClcnum(rs.getLong("CLCNUM"));
        aa2clico.setClcana(rs.getLong("CLCANA"));
        aa2clico.setClctid(rs.getString("CLCTID"));
        aa2clico.setClcnif(rs.getString("CLCNIF"));
        aa2clico.setClctel(rs.getLong("CLCTEL"));
        aa2clico.setClcusu(rs.getString("CLCUSU"));
