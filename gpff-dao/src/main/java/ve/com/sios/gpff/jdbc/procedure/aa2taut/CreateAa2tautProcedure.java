...
/**
 * The Class CreateAa2tautProcedure.
 *
 ...
 */
@Service
public class CreateAa2tautProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateAa2taut";

    /**
     * Instantiates a new creates the aa 2 taut procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateAa2tautProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Aa2taut aa2taut, AuthorizationData authorizationData) throws Exception {
