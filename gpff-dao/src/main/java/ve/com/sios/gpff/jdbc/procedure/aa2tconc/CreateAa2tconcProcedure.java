...
/**
 * The Class CreateAa2tconcProcedure.
 *
 ...
 */
@Service
public class CreateAa2tconcProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateAa2tconc";

    /**
     * Instantiates a new creates the aa 2 tconc procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateAa2tconcProcedure(DataSource dataSource) {
        ...
        declareParameter(new SqlOutParameter("P_CONCLA", Types.BIGINT));
     ...
     */
    public int execute(Aa2tconc aa2tconc, AuthorizationData authorizationData) throws GpffDaoException {
        ...
        try {
            ...
            return (Integer) maps.get("P_CONCLA");
        } catch (Exception e) {
