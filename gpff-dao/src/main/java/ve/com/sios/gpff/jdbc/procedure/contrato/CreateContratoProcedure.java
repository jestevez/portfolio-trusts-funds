...
/**
 * The Class CreateContratoProcedure.
 *
 ...
 */
@Service
public class CreateContratoProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateContrato";

    /**
     * Instantiates a new creates the contrato procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateContratoProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Contrato contrato, AuthorizationData authorizationData) throws Exception {
