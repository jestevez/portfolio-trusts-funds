...
/**
 * The Class CreateDtdctaProcedure.
 *
 ...
 */
@Service
public class CreateDtdctaProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateDtdcta";

    /**
     * Instantiates a new creates the dtdcta procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateDtdctaProcedure(DataSource dataSource) {
        ...
        declareParameter(new SqlOutParameter("P_DTINIF_O", Types.VARCHAR));
     ...
     */
    public String execute(Dtdcta dtdcta, AuthorizationData authorizationData) throws GpffDaoException {
