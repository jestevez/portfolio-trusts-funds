...
/**
 * The Class CreateTabcfProcedure.
 *
 ...
 */
@Service
public class CreateTabcfProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateTabcf";

    /**
     * Instantiates a new creates the tabcf procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateTabcfProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Tabcf tabcf, AuthorizationData authorizationData) throws GpffDaoException {
