...
/**
 * The Class CreateAa2copoProcedure.
 *
 ...
 */
@Service
public class CreateAa2copoProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateAa2copo";

    /**
     * Instantiates a new creates the aa 2 copo procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateAa2copoProcedure(DataSource dataSource) {
        ...
        declareParameter(new SqlOutParameter("P_COPCOD_O", Types.INTEGER));
     ...
     */
    public int execute(Aa2copo aa2copo, AuthorizationData authorizationData) throws GpffDaoException {
        ...
        try {
            ...
            return (Integer) maps.get("P_COPCOD_O");
        } catch (Exception e) {
