...
/**
 * The Class CreateAa2balssProcedure.
 *
 ...
 */
@Service
public class CreateAa2balssProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateAa2balss";

    /**
     * Instantiates a new creates the aa 2 balss procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateAa2balssProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Aa2balss aa2balss, AuthorizationData authorizationData) throws GpffDaoException {
