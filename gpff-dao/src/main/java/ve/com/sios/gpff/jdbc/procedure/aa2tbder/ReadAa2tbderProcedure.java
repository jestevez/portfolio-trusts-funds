...
/**
 * The Class ReadAa2tbderProcedure.
 *
 ...
 */
@Service
public class ReadAa2tbderProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procReadAa2tbder";

    /**
     * Instantiates a new read aa 2 tbder procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public ReadAa2tbderProcedure(DataSource dataSource) {
        ...
        declareParameter(new SqlReturnResultSet("RS", new Aa2tbderMapper()));
     ...
     */
    public List execute(Aa2tbder aa2tbder, int firstResult, int maxResults, String sortClause, AuthorizationData authorizationData) throws GpffDaoException {
...
class Aa2tbderMapper implements RowMapper<Aa2tbder> {

    public Aa2tbder mapRow(ResultSet rs, int i) throws SQLException {
        Aa2tbder aa2tbder = new Aa2tbder();
        aa2tbder.setTCAULT(rs.getLong("TCAULT"));
        aa2tbder.setTCAMX1(rs.getDouble("TCAMX1"));
        aa2tbder.setTCAVL1(rs.getDouble("TCAVL1"));
        aa2tbder.setTCAPR1(rs.getDouble("TCAPR1"));
        aa2tbder.setTCAVL2(rs.getDouble("TCAVL2"));
        aa2tbder.setTCAPR2(rs.getDouble("TCAPR2"));
        aa2tbder.setTCAVL3(rs.getDouble("TCAVL3"));
        aa2tbder.setTCAPR3(rs.getDouble("TCAPR3"));
        aa2tbder.setTCAVL4(rs.getDouble("TCAVL4"));
        aa2tbder.setTCAPR4(rs.getDouble("TCAPR4"));
        aa2tbder.setTCAFEC(rs.getInt("TCAFEC"));
