...
/**
 * The Class DeleteGpprpopcProcedure.
 *
 ...
 */
@Service
public class DeleteGpprpopcProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procDeleteGpprpopc";

    /**
     * Instantiates a new delete gpprpopc procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public DeleteGpprpopcProcedure(DataSource dataSource) {
