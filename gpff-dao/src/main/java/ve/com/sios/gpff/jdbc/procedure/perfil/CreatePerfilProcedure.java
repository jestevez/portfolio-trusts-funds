...
/**
 * The Class CreatePerfilProcedure.
 *
 ...
 */
@Service
public class CreatePerfilProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreatePerfil";

    /**
     * Instantiates a new creates the perfil procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreatePerfilProcedure(DataSource dataSource) {
        ...
        declareParameter(new SqlOutParameter("P_MSGCODE", Types.VARCHAR));
     ...
     */
    public int execute(Perfil perfil, AuthorizationData authorizationData) throws GpffDaoException {
