...
/**
 * The Class CountFluconProcedure.
 *
 ...
 */
@Service
public class CountFluconProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountFlucon";

    /**
     * Instantiates a new count flucon procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountFluconProcedure(DataSource dataSource) {
