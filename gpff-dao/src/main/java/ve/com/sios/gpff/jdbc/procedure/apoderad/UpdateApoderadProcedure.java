...
/**
 * The Class UpdateApoderadProcedure.
 *
 ...
 */
@Service
public class UpdateApoderadProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateApoderad";

    /**
     * Instantiates a new update apoderad procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateApoderadProcedure(DataSource dataSource) {
