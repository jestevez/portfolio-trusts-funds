...
/**
 * The Class UpdateAa2ctaProcedure.
 *
 ...
 */
@Service
public class UpdateAa2ctaProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateAa2cta";

    /**
     * Instantiates a new update aa 2 cta procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateAa2ctaProcedure(DataSource dataSource) {
