...
/**
 * The Class DeleteAa2comiProcedure.
 *
 ...
 */
@Service
public class DeleteAa2comiProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procDeleteAa2comi";

    /**
     * Instantiates a new delete aa 2 comi procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public DeleteAa2comiProcedure(DataSource dataSource) {
