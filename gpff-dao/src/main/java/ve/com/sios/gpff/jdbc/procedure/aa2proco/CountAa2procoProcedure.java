...
/**
 * The Class CountAa2procoProcedure.
 *
 ...
 */
@Service
public class CountAa2procoProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountAa2proco";

    /**
     * Instantiates a new count aa 2 proco procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountAa2procoProcedure(DataSource dataSource) {
