...
/**
 * The Class DeleteAa2tocProcedure.
 *
 ...
 */
@Service
public class DeleteAa2tocProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procDeleteAa2toc";

    /**
     * Instantiates a new delete aa 2 toc procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public DeleteAa2tocProcedure(DataSource dataSource) {
