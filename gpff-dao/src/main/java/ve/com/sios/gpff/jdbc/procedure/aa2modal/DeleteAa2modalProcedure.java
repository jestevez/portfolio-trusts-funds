 ...
 */
@Service
public class DeleteAa2modalProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procDeleteAa2modal";

    /**
     * Instantiates a new delete aa 2 modal procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public DeleteAa2modalProcedure(DataSource dataSource) {
