...
/**
 * The Class CountTabsexProcedure.
 *
 ...
 */
@Service
public class CountTabsexProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountTabsex";

    /**
     * Instantiates a new count tabsex procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountTabsexProcedure(DataSource dataSource) {
