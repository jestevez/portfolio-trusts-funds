 ...
 */
@Service
public class ReadAa2ampProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procReadAa2amp";

    /**
     * Instantiates a new read aa 2 amp procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public ReadAa2ampProcedure(DataSource dataSource) {
        ...
        declareParameter(new SqlReturnResultSet("RS", new Aa2ampMapper()));
...
class Aa2ampMapper implements RowMapper<Aa2amp> {

    public Aa2amp mapRow(ResultSet rs, int i) throws SQLException {
        Aa2amp aa2amp = new Aa2amp();
        aa2amp.setAmptip(rs.getString("AMPTIP"));
        aa2amp.setAmpdes(rs.getString("AMPDES"));
        aa2amp.setAmpcau(rs.getString("AMPCAU"));
