...
/**
 * The Class UpdateAa2emisoProcedure.
 *
 ...
 */
@Service
public class UpdateAa2emisoProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateAa2emiso";

    /**
     * Instantiates a new update aa 2 emiso procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateAa2emisoProcedure(DataSource dataSource) {
