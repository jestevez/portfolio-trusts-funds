...
/**
 * The Class CreateAa2ttproProcedure.
 *
 ...
 */
@Service
public class CreateAa2ttproProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateAa2ttpro";

    /**
     * Instantiates a new creates the aa 2 ttpro procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateAa2ttproProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Aa2ttpro aa2ttpro, AuthorizationData authorizationData) throws Exception {
