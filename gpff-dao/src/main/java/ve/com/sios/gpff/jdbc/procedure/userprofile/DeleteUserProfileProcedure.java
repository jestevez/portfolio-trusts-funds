/*
 * DeleteUserProfileProcedure.java
 *
...
/**
 * The Class DeleteUserProfileProcedure.
 *
 ...
 */
@Service
public class DeleteUserProfileProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procDeleteUserProfile";

    /**
     * Instantiates a new delete user profile procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public DeleteUserProfileProcedure(DataSource dataSource) {
