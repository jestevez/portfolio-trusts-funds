...
/**
 * The Class CountAa2balxiProcedure.
 *
 ...
 */
@Service
public class CountAa2balxiProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountAa2balxi";

    /**
     * Instantiates a new count aa 2 balxi procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountAa2balxiProcedure(DataSource dataSource) {
