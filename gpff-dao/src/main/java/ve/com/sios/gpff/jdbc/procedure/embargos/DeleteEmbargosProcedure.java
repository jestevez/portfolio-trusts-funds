...
/**
 * The Class DeleteEmbargosProcedure.
 *
 ...
 */
@Service
public class DeleteEmbargosProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procDeleteEmbargos";

    /**
     * Instantiates a new delete embargos procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public DeleteEmbargosProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Embargos embargos, AuthorizationData authorizationData) throws Exception {
