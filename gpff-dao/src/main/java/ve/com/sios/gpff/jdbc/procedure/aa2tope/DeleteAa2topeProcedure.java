...
/**
 * The Class DeleteAa2topeProcedure.
 *
 ...
 */
@Service
public class DeleteAa2topeProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procDeleteAa2tope";

    /**
     * Instantiates a new delete aa 2 tope procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public DeleteAa2topeProcedure(DataSource dataSource) {
