...
/**
 * The Class CountAa2clicoProcedure.
 *
 ...
 */
@Service
public class CountAa2clicoProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountAa2clico";

    /**
     * Instantiates a new count aa 2 clico procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountAa2clicoProcedure(DataSource dataSource) {
