/*
 * UpdateUserProfileProcedure.java
 *
...
/**
 * The Class UpdateUserProfileProcedure.
 *
 ...
 */
@Service
public class UpdateUserProfileProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateUserProfile";

    /**
     * Instantiates a new update user profile procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateUserProfileProcedure(DataSource dataSource) {
