...
/**
 * The Class CountCuentasProcedure.
 *
 ...
 */
@Service
public class CountCuentasProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountCuentas";

    /**
     * Instantiates a new count cuentas procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountCuentasProcedure(DataSource dataSource) {
