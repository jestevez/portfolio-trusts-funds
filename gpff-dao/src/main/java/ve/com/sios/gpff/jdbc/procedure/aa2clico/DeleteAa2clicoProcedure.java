...
/**
 * The Class DeleteAa2clicoProcedure.
 *
 ...
 */
@Service
public class DeleteAa2clicoProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procDeleteAa2clico";

    /**
     * Instantiates a new delete aa 2 clico procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public DeleteAa2clicoProcedure(DataSource dataSource) {
