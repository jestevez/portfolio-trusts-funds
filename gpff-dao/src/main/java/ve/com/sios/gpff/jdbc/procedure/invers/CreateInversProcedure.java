...
/**
 * The Class CreateInversProcedure.
 *
 ...
 */
@Service
public class CreateInversProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateInvers";

    /**
     * Instantiates a new creates the invers procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateInversProcedure(DataSource dataSource) {
