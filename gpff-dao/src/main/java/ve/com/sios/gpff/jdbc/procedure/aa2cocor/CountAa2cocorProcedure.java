...
/**
 * The Class CountAa2cocorProcedure.
 *
 ...
 */
@Service
public class CountAa2cocorProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountAa2cocor";

    /**
     * Instantiates a new count aa 2 cocor procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountAa2cocorProcedure(DataSource dataSource) {
