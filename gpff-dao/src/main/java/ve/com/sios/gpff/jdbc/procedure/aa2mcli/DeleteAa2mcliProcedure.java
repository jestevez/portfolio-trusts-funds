...
/**
 * The Class DeleteAa2mcliProcedure.
 *
 ...
 */
@Service
public class DeleteAa2mcliProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procDeleteAa2mcli";

    /**
     * Instantiates a new delete aa 2 mcli procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public DeleteAa2mcliProcedure(DataSource dataSource) {
