...
/**
 * The Class CountAa2rettProcedure.
 *
 ...
 */
@Service
public class CountAa2rettProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountAa2rett";

    /**
     * Instantiates a new count aa 2 rett procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountAa2rettProcedure(DataSource dataSource) {
