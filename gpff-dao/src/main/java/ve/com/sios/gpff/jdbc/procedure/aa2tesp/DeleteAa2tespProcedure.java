...
/**
 * The Class DeleteAa2tespProcedure.
 *
 ...
 */
@Service
public class DeleteAa2tespProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procDeleteAa2tesp";

    /**
     * Instantiates a new delete aa 2 tesp procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public DeleteAa2tespProcedure(DataSource dataSource) {
