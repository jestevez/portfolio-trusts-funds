...
/**
 * The Class CountAa2balsiProcedure.
 *
 ...
 */
@Service
public class CountAa2balsiProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountAa2balsi";

    /**
     * Instantiates a new count aa 2 balsi procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountAa2balsiProcedure(DataSource dataSource) {
