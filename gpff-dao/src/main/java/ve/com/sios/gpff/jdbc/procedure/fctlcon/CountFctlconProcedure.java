...
/**
 * The Class CountFctlconProcedure.
 *
 ...
 */
@Service
public class CountFctlconProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountFctlcon";

    /**
     * Instantiates a new count fctlcon procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountFctlconProcedure(DataSource dataSource) {
