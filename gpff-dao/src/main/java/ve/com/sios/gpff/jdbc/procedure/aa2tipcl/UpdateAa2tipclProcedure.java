...
/**
 * The Class UpdateAa2tipclProcedure.
 *
 ...
 */
@Service
public class UpdateAa2tipclProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateAa2tipcl";

    /**
     * Instantiates a new update aa 2 tipcl procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateAa2tipclProcedure(DataSource dataSource) {
