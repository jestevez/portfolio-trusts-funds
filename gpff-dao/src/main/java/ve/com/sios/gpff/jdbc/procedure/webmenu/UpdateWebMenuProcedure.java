...
/**
 * The Class UpdateWebMenuProcedure.
 *
 ...
 */
@Service
public class UpdateWebMenuProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateWebMenu";

    /**
     * Instantiates a new update web menu procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateWebMenuProcedure(DataSource dataSource) {
     ...
     */
    public boolean execute(WebMenu webMenu, AuthorizationData authorizationData) throws Exception {
