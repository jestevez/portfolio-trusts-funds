...
/**
 * The Class CreateAa2atoProcedure.
 *
 ...
 */
@Service
public class CreateAa2atoProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateAa2ato";

    /**
     * Instantiates a new creates the aa 2 ato procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateAa2atoProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Aa2ato aa2ato, AuthorizationData authorizationData) throws GpffDaoException {
        ...
        inParams.put("P_ATOEMP", aa2ato.getAtodel());
