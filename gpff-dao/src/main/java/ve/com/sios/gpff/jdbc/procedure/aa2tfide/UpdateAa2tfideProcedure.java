...
/**
 * The Class UpdateAa2tfideProcedure.
 *
 ...
 */
@Service
public class UpdateAa2tfideProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateAa2tfide";

    /**
     * Instantiates a new update aa 2 tfide procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateAa2tfideProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Aa2tfide aa2tfide, AuthorizationData authorizationData) throws Exception {
