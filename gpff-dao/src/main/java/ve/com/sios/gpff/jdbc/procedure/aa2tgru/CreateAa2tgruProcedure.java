...
/**
 * The Class CreateAa2tgruProcedure.
 *
 ...
 */
@Service
public class CreateAa2tgruProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateAa2tgru";

    /**
     * Instantiates a new creates the aa 2 tgru procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateAa2tgruProcedure(DataSource dataSource) {
        ...
        declareParameter(new SqlOutParameter("P_GRUCLA", Types.INTEGER));
     ...
     */
    public int execute(Aa2tgru aa2tgru, AuthorizationData authorizationData) throws GpffDaoException {
        ...
        try {
            ...
            return (Integer) maps.get("P_GRUCLA");
        } catch (Exception e) {
