...
/**
 * The Class UpdateAa2atohProcedure.
 *
 ...
 */
@Service
public class UpdateAa2atohProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateAa2atoh";

    /**
     * Instantiates a new update aa 2 atoh procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateAa2atohProcedure(DataSource dataSource) {
