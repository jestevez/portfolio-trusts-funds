...
/**
 * The Class CountAa2gestoProcedure.
 *
 ...
 */
@Service
public class CountAa2gestoProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountAa2gesto";

    /**
     * Instantiates a new count aa 2 gesto procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountAa2gestoProcedure(DataSource dataSource) {
