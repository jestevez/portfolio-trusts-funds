...
/**
 * The Class CountAa2tfideProcedure.
 *
 ...
 */
@Service
public class CountAa2tfideProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountAa2tfide";

    /**
     * Instantiates a new count aa 2 tfide procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountAa2tfideProcedure(DataSource dataSource) {
