...
/**
 * The Class CreateAa2traidProcedure.
 *
 ...
 */
@Service
public class CreateAa2traidProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateAa2traid";

    /**
     * Instantiates a new creates the aa 2 traid procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateAa2traidProcedure(DataSource dataSource) {
        super(dataSource, SP_NAME);
        declareParameter(new SqlParameter("P_TRACLA", Types.BIGINT));
        ...
        declareParameter(new SqlOutParameter("P_TRACLA_O", Types.BIGINT));
     ...
     */
    public Long execute(Aa2traid aa2traid, AuthorizationData authorizationData) throws GpffDaoException {
        ...
        try {
            ...
            return (Long) maps.get("P_TRACLA_O");
        } catch (Exception e) {
