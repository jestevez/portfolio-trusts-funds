...
/**
 * The Class CountAa2tpaisProcedure.
 *
 ...
 */
@Service
public class CountAa2tpaisProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountAa2tpais";

    /**
     * Instantiates a new count aa 2 tpais procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountAa2tpaisProcedure(DataSource dataSource) {
