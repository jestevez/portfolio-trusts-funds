...
/**
 * The Class CreateAa2procoProcedure.
 *
 ...
 */
@Service
public class CreateAa2procoProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateAa2proco";

    /**
     * Instantiates a new creates the aa 2 proco procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateAa2procoProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Aa2proco aa2proco, AuthorizationData authorizationData) throws GpffDaoException {
