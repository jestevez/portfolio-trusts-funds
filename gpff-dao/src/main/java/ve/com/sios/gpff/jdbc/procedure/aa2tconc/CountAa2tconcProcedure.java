...
/**
 * The Class CountAa2tconcProcedure.
 *
 ...
 */
@Service
public class CountAa2tconcProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountAa2tconc";

    /**
     * Instantiates a new count aa 2 tconc procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountAa2tconcProcedure(DataSource dataSource) {
