...
/**
 * The Class UpdateAa2procoProcedure.
 *
 ...
 */
@Service
public class UpdateAa2procoProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateAa2proco";

    /**
     * Instantiates a new update aa 2 proco procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateAa2procoProcedure(DataSource dataSource) {
