...
/**
 * The Class CountConact1Procedure.
 *
 ...
 */
@Service
public class CountConact1Procedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountConact1";

    /**
     * Instantiates a new count conact 1 procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountConact1Procedure(DataSource dataSource) {
     ...
     */
    public int execute(Conact1 conact1, AuthorizationData authorizationData) throws GpffDaoException {
