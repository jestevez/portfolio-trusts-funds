...
/**
 * The Class CountAa2mcliProcedure.
 *
 ...
 */
@Service
public class CountAa2mcliProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountAa2mcli";

    /**
     * Instantiates a new count aa 2 mcli procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountAa2mcliProcedure(DataSource dataSource) {
