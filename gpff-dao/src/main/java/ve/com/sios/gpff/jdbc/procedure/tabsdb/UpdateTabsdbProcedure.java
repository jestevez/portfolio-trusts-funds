 ...
 */
@Service
public class UpdateTabsdbProcedure extends StoredProcedure {

    private static final String SP_NAME = "procUpdateTabsdb";

    @Autowired
    public UpdateTabsdbProcedure(DataSource dataSource) {
