...
/**
 * The Class CreateTabsdbProcedure.
 *
 ...
 */
@Service
public class CreateTabsdbProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateTabsdb";

    /**
     * Instantiates a new creates the tabsdb procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateTabsdbProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Tabsdb tabsdb, AuthorizationData authorizationData) throws GpffDaoException {
