...
/**
 * The Class ReadTableHelpProcedure.
 *
 ...
 */
@Service
public class ReadTableHelpProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procReadTableHelp";

    /**
     * Instantiates a new read table help procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public ReadTableHelpProcedure(DataSource dataSource) {
        ...
        declareParameter(new SqlReturnResultSet("RS", new TableHelpMapper()));
...
class TableHelpMapper implements RowMapper<TableHelp> {

    public TableHelp mapRow(ResultSet rs, int i) throws SQLException {
        TableHelp tableHelp = new TableHelp();
        tableHelp.setId(rs.getLong("ID"));
        tableHelp.setCode(rs.getString("CODE"));
        tableHelp.setName(rs.getString("NAME"));
        tableHelp.setTableName(rs.getString("TABLENAME"));
        tableHelp.setTableCode(rs.getString("TABLECODE"));
        tableHelp.setTableDesc(rs.getString("TABLEDESC"));
        tableHelp.setTableParent(rs.getString("TABLEPARENT"));
