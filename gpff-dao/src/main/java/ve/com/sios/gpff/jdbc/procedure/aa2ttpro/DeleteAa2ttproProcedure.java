...
/**
 * The Class DeleteAa2ttproProcedure.
 *
 ...
 */
@Service
public class DeleteAa2ttproProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procDeleteAa2ttpro";

    /**
     * Instantiates a new delete aa 2 ttpro procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public DeleteAa2ttproProcedure(DataSource dataSource) {
