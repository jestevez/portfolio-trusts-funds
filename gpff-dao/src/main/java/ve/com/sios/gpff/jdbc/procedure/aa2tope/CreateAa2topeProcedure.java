...
/**
 * The Class CreateAa2topeProcedure.
 *
 ...
 */
@Service
public class CreateAa2topeProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateAa2tope";

    /**
     * Instantiates a new creates the aa 2 tope procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateAa2topeProcedure(DataSource dataSource) {
        ...
        declareParameter(new SqlOutParameter("P_OPECLA", Types.INTEGER));
    ...
    public int execute(Aa2tope aa2tope, AuthorizationData authorizationData) throws Exception {
        ...
        try {
            ...
            return (Integer) maps.get("P_OPECLA");
        } catch (Exception e) {
