...
/**
 * The Class CountCupamortProcedure.
 *
 ...
 */
@Service
public class CountCupamortProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountCupamort";

    /**
     * Instantiates a new count cupamort procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountCupamortProcedure(DataSource dataSource) {
