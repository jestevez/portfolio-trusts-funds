...
/**
 * The Class UpdateAa2cabProcedure.
 *
 ...
 */
@Service
public class UpdateAa2cabProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateAa2cab";

    /**
     * Instantiates a new update aa 2 cab procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateAa2cabProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Aa2cab aa2cab, AuthorizationData authorizationData) throws Exception {
