...
/**
 * The Class UpdateAa2reteProcedure.
 *
 ...
 */
@Service
public class UpdateAa2reteProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateAa2rete";

    /**
     * Instantiates a new update aa 2 rete procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateAa2reteProcedure(DataSource dataSource) {
