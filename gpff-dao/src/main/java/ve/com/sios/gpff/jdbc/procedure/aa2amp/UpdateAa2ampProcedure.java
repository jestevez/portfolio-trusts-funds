...
/**
 * The Class UpdateAa2ampProcedure.
 *
 ...
 */
@Service
public class UpdateAa2ampProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateAa2amp";

    /**
     * Instantiates a new update aa 2 amp procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateAa2ampProcedure(DataSource dataSource) {
