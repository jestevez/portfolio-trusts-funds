...
/**
 * The Class UpdateAa2cocorProcedure.
 *
 ...
 */
@Service
public class UpdateAa2cocorProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateAa2cocor";

    /**
     * Instantiates a new update aa 2 cocor procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateAa2cocorProcedure(DataSource dataSource) {
