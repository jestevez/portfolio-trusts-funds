...
/**
 * The Class DeleteAuxcontProcedure.
 *
 ...
 */
@Service
public class DeleteAuxcontProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procDeleteAuxcont";

    /**
     * Instantiates a new delete auxcont procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public DeleteAuxcontProcedure(DataSource dataSource) {
