...
/**
 * The Class CountTableHelpProcedure.
 *
 ...
 */
@Service
public class CountTableHelpProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountTableHelp";

    /**
     * Instantiates a new count table help procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountTableHelpProcedure(DataSource dataSource) {
