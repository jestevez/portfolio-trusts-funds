...
/**
 * The Class DeleteAa2balsiProcedure.
 *
 ...
 */
@Service
public class DeleteAa2balsiProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procDeleteAa2balsi";

    /**
     * Instantiates a new delete aa 2 balsi procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public DeleteAa2balsiProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Aa2balsi aa2balsi, AuthorizationData authorizationData) throws GpffDaoException {
