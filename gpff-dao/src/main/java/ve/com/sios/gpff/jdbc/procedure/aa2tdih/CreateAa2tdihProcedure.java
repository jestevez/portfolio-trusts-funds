...
/**
 * The Class CreateAa2tdihProcedure.
 *
 ...
 */
@Service
public class CreateAa2tdihProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateAa2tdih";

    /**
     * Instantiates a new creates the aa 2 tdih procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateAa2tdihProcedure(DataSource dataSource) {
        ...
        declareParameter(new SqlOutParameter("P_MSGCODE", Types.BIGINT));
     ...
     */
    public int execute(Aa2tdih aa2tdih, AuthorizationData authorizationData) throws GpffDaoException {
