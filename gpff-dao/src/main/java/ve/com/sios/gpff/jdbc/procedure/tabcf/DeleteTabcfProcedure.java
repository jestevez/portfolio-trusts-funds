...
/**
 * The Class DeleteTabcfProcedure.
 *
 ...
 */
@Service
public class DeleteTabcfProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procDeleteTabcf";

    /**
     * Instantiates a new delete tabcf procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public DeleteTabcfProcedure(DataSource dataSource) {
