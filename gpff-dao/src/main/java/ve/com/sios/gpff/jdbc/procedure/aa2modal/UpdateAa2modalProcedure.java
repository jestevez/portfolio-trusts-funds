...
/**
 * The Class UpdateAa2modalProcedure.
 *
 ...
 */
@Service
public class UpdateAa2modalProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateAa2modal";

    /**
     * Instantiates a new update aa 2 modal procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateAa2modalProcedure(DataSource dataSource) {
