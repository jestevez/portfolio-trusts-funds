...
/**
 * The Class DeleteProductosProcedure.
 *
 ...
 */
@Service
public class DeleteProductosProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procDeleteProductos";

    /**
     * Instantiates a new delete productos procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public DeleteProductosProcedure(DataSource dataSource) {
