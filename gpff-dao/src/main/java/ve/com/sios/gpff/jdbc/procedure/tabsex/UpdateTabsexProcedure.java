...
/**
 * The Class UpdateTabsexProcedure.
 *
 ...
 */
@Service
public class UpdateTabsexProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateTabsex";

    /**
     * Instantiates a new update tabsex procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateTabsexProcedure(DataSource dataSource) {
