...
/**
 * The Class CountValoraProcedure.
 *
 ...
 */
@Service
public class CountValoraProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountValora";

    /**
     * Instantiates a new count valora procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountValoraProcedure(DataSource dataSource) {
