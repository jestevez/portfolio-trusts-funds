...
/**
 * The Class UpdateCupamortProcedure.
 *
 ...
 */
@Service
public class UpdateCupamortProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateCupamort";

    /**
     * Instantiates a new update cupamort procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateCupamortProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Cupamort cupamort, AuthorizationData authorizationData) throws Exception {
