...
/**
 * The Class CreateCuentasProcedure.
 *
 ...
 */
@Service
public class CreateCuentasProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateCuentas";

    /**
     * Instantiates a new creates the cuentas procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateCuentasProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Cuentas cuentas, AuthorizationData authorizationData) throws GpffDaoException {
