...
/**
 * The Class DeleteAa2traidProcedure.
 *
 ...
 */
@Service
public class DeleteAa2traidProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procDeleteAa2traid";

    /**
     * Instantiates a new delete aa 2 traid procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public DeleteAa2traidProcedure(DataSource dataSource) {
