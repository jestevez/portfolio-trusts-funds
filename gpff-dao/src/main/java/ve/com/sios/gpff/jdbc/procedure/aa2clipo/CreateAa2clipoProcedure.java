...
/**
 * The Class CreateAa2clipoProcedure.
 *
 ...
 */
@Service
public class CreateAa2clipoProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateAa2clipo";

    /**
     * Instantiates a new creates the aa 2 clipo procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateAa2clipoProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Aa2clipo aa2clipo, AuthorizationData authorizationData) throws Exception {
