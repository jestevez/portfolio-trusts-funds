...
/**
 * The Class UpdateGpprpopcProcedure.
 *
 ...
 */
@Service
public class UpdateGpprpopcProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateGpprpopc";

    /**
     * Instantiates a new update gpprpopc procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateGpprpopcProcedure(DataSource dataSource) {
