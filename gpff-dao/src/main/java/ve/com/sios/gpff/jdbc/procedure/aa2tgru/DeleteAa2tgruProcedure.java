...
/**
 * The Class DeleteAa2tgruProcedure.
 *
 ...
 */
@Service
public class DeleteAa2tgruProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procDeleteAa2tgru";

    /**
     * Instantiates a new delete aa 2 tgru procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public DeleteAa2tgruProcedure(DataSource dataSource) {
