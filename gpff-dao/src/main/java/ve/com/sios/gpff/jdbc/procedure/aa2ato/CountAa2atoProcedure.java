...
/**
 * The Class CountAa2atoProcedure.
 *
 ...
 */
@Service
public class CountAa2atoProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountAa2ato";

    /**
     * Instantiates a new count aa 2 ato procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountAa2atoProcedure(DataSource dataSource) {
