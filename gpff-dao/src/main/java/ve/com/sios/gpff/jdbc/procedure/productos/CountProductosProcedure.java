...
/**
 * The Class CountProductosProcedure.
 *
 ...
 */
@Service
public class CountProductosProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountProductos";

    /**
     * Instantiates a new count productos procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountProductosProcedure(DataSource dataSource) {
