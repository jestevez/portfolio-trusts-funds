...
/**
 * The Class UpdateAa2balssProcedure.
 *
 ...
 */
@Service
public class UpdateAa2balssProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateAa2balss";

    /**
     * Instantiates a new update aa 2 balss procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateAa2balssProcedure(DataSource dataSource) {
