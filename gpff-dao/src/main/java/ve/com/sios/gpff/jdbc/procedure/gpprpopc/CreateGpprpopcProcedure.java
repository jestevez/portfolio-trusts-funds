...
/**
 * The Class CreateGpprpopcProcedure.
 *
 ...
 */
@Service
public class CreateGpprpopcProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateGpprpopc";

    /**
     * Instantiates a new creates the gpprpopc procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateGpprpopcProcedure(DataSource dataSource) {
