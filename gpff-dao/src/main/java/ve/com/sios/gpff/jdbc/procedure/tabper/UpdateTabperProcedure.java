...
/**
 * The Class UpdateTabperProcedure.
 *
 ...
 */
@Service
public class UpdateTabperProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateTabper";

    /**
     * Instantiates a new update tabper procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateTabperProcedure(DataSource dataSource) {
