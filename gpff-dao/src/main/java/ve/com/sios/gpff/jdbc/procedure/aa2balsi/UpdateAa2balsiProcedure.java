...
/**
 * The Class UpdateAa2balsiProcedure.
 *
 ...
 */
@Service
public class UpdateAa2balsiProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateAa2balsi";

    /**
     * Instantiates a new update aa 2 balsi procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateAa2balsiProcedure(DataSource dataSource) {
