...
/**
 * The Class CountAa2ctaProcedure.
 *
 ...
 */
@Service
public class CountAa2ctaProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountAa2cta";

    /**
     * Instantiates a new count aa 2 cta procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountAa2ctaProcedure(DataSource dataSource) {
