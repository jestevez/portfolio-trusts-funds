...
/**
 * The Class DeleteCuentasProcedure.
 *
 ...
 */
@Service
public class DeleteCuentasProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procDeleteCuentas";

    /**
     * Instantiates a new delete cuentas procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public DeleteCuentasProcedure(DataSource dataSource) {
