...
/**
 * The Class CountAa2modalProcedure.
 *
 ...
 */
@Service
public class CountAa2modalProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountAa2modal";

    /**
     * Instantiates a new count aa 2 modal procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountAa2modalProcedure(DataSource dataSource) {
