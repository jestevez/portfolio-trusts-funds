...
/**
 * The Class UpdateAa2tespProcedure.
 *
 ...
 */
@Service
public class UpdateAa2tespProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateAa2tesp";

    /**
     * Instantiates a new update aa 2 tesp procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateAa2tespProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Aa2tesp aa2tesp, AuthorizationData authorizationData) throws Exception {
