...
/**
 * The Class UpdateAa2coopeProcedure.
 *
 ...
 */
@Service
public class UpdateAa2coopeProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateAa2coope";

    /**
     * Instantiates a new update aa 2 coope procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateAa2coopeProcedure(DataSource dataSource) {
