...
/**
 * The Class CreateAa2tocProcedure.
 *
 ...
 */
@Service
public class CreateAa2tocProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateAa2toc";

    /**
     * Instantiates a new creates the aa 2 toc procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateAa2tocProcedure(DataSource dataSource) {
        ...
        declareParameter(new SqlOutParameter("P_TOCTIP_O", Types.INTEGER));
    ...
    public int execute(Aa2toc aa2toc, AuthorizationData authorizationData) throws GpffDaoException {
        ...
        try {
            ...
            return (Integer) maps.get("P_TOCTIP_O");
        } catch (Exception e) {
