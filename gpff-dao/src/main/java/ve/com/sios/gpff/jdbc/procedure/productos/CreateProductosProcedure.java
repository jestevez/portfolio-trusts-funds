...
/**
 * The Class CreateProductosProcedure.
 *
 ...
 */
@Service
public class CreateProductosProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateProductos";

    /**
     * Instantiates a new creates the productos procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateProductosProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Productos productos, AuthorizationData authorizationData) throws Exception {
