...
/**
 * The Class UpdateTabcfProcedure.
 *
 ...
 */
@Service
public class UpdateTabcfProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateTabcf";

    /**
     * Instantiates a new update tabcf procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateTabcfProcedure(DataSource dataSource) {
