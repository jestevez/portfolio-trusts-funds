...
/**
 * The Class UpdateSplfileProcedure.
 *
 ...
 */
@Service
public class UpdateSplfileProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateSplfile";

    /**
     * Instantiates a new update splfile procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateSplfileProcedure(DataSource dataSource) {
