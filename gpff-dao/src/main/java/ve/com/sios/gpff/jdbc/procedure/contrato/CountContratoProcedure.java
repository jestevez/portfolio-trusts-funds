...
/**
 * The Class CountContratoProcedure.
 *
 ...
 */
@Service
public class CountContratoProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountContrato";

    /**
     * Instantiates a new count contrato procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountContratoProcedure(DataSource dataSource) {
