...
/**
 * The Class CountAa2cabProcedure.
 *
 ...
 */
@Service
public class CountAa2cabProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountAa2cab";

    /**
     * Instantiates a new count aa 2 cab procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountAa2cabProcedure(DataSource dataSource) {
