...
/**
 * The Class DeleteAa2tautProcedure.
 *
 ...
 */
@Service
public class DeleteAa2tautProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procDeleteAa2taut";

    /**
     * Instantiates a new delete aa 2 taut procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public DeleteAa2tautProcedure(DataSource dataSource) {
