...
/**
 * The Class DeleteAa2clipoProcedure.
 *
 ...
 */
@Service
public class DeleteAa2clipoProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procDeleteAa2clipo";

    /**
     * Instantiates a new delete aa 2 clipo procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public DeleteAa2clipoProcedure(DataSource dataSource) {
