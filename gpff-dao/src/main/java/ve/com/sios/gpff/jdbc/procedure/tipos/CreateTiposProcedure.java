...
/**
 * The Class CreateTiposProcedure.
 *
 ...
 */
@Service
public class CreateTiposProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateTipos";

    /**
     * Instantiates a new creates the tipos procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateTiposProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Tipos tipos, AuthorizationData authorizationData) throws Exception {
