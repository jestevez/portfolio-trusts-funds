...
/**
 * The Class CountTabsdbProcedure.
 *
 ...
 */
@Service
public class CountTabsdbProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountTabsdb";

    /**
     * Instantiates a new count tabsdb procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountTabsdbProcedure(DataSource dataSource) {
