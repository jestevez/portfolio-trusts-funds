...
/**
 * The Class CreateAa2tbderProcedure.
 *
 ...
 */
@Service
public class CreateAa2tbderProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateAa2tbder";

    /**
     * Instantiates a new creates the aa 2 tbder procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateAa2tbderProcedure(DataSource dataSource) {
        ...
        declareParameter(new SqlOutParameter("P_TCAULT", Types.INTEGER));
     ...
     */
    public int execute(Aa2tbder aa2tbder, AuthorizationData authorizationData) throws Exception {
        ...
        try {
            ...
            return (Integer) maps.get("P_TCAULT_O");
        } catch (Exception e) {
