...
/**
 * The Class UpdateTabntpaProcedure.
 *
 ...
 */
@Service
public class UpdateTabntpaProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateTabntpa";

    /**
     * Instantiates a new update tabntpa procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateTabntpaProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Tabntpa tabntpa, AuthorizationData authorizationData) throws GpffDaoException {
