...
/**
 * The Class UpdateAa2clipoProcedure.
 *
 ...
 */
@Service
public class UpdateAa2clipoProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateAa2clipo";

    /**
     * Instantiates a new update aa 2 clipo procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateAa2clipoProcedure(DataSource dataSource) {
