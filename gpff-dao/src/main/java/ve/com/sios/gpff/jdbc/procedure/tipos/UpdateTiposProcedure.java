...
/**
 * The Class UpdateTiposProcedure.
 *
 ...
 */
@Service
public class UpdateTiposProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateTipos";

    /**
     * Instantiates a new update tipos procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateTiposProcedure(DataSource dataSource) {
