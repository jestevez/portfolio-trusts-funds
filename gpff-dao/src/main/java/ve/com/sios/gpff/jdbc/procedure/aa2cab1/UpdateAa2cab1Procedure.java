...
/**
 * The Class UpdateAa2cab1Procedure.
 *
 ...
 */
@Service
public class UpdateAa2cab1Procedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateAa2cab1";

    /**
     * Instantiates a new update aa 2 cab 1 procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateAa2cab1Procedure(DataSource dataSource) {
