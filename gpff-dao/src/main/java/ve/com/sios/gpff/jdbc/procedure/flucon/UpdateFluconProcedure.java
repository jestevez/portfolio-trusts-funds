...
/**
 * The Class UpdateFluconProcedure.
 *
 ...
 */
@Service
public class UpdateFluconProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateFlucon";

    /**
     * Instantiates a new update flucon procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateFluconProcedure(DataSource dataSource) {
