...
/**
 * The Class CreateValoraProcedure.
 *
 ...
 */
@Service
public class CreateValoraProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateValora";

    /**
     * Instantiates a new creates the valora procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateValoraProcedure(DataSource dataSource) {
        ...
        declareParameter(new SqlOutParameter("P_VLOCON", Types.BIGINT));
     ...
     */
    public int execute(Valora valora, AuthorizationData authorizationData) throws Exception {
        ...
        try {
            ...
            return (Integer) maps.get("P_VLOCON");
        } catch (Exception e) {
