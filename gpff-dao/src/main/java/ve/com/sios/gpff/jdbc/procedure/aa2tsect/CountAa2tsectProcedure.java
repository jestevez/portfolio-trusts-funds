...
/**
 * The Class CountAa2tsectProcedure.
 *
 ...
 */
@Service
public class CountAa2tsectProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountAa2tsect";

    /**
     * Instantiates a new count aa 2 tsect procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountAa2tsectProcedure(DataSource dataSource) {
