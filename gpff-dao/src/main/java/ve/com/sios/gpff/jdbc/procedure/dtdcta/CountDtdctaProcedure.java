...
/**
 * The Class CountDtdctaProcedure.
 *
 ...
 */
@Service
public class CountDtdctaProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountDtdcta";

    /**
     * Instantiates a new count dtdcta procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountDtdctaProcedure(DataSource dataSource) {
