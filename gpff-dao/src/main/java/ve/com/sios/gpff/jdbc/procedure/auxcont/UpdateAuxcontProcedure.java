...
/**
 * The Class UpdateAuxcontProcedure.
 *
 ...
 */
@Service
public class UpdateAuxcontProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateAuxcont";

    /**
     * Instantiates a new update auxcont procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateAuxcontProcedure(DataSource dataSource) {
