...
/**
 * The Class CountPerfilProcedure.
 *
 ...
 */
@Service
public class CountPerfilProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountPerfil";

    /**
     * Instantiates a new count perfil procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountPerfilProcedure(DataSource dataSource) {
