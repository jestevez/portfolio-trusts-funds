...
/**
 * The Class CreateCotfondoProcedure.
 *
 ...
 */
@Service
public class CreateCotfondoProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateCotfondo";

    /**
     * Instantiates a new creates the cotfondo procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateCotfondoProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Cotfondo cotfondo, AuthorizationData authorizationData) throws Exception {
