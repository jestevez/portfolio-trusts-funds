...
/**
 * The Class CreateAa2reteProcedure.
 *
 ...
 */
@Service
public class CreateAa2reteProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateAa2rete";

    /**
     * Instantiates a new creates the aa 2 rete procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateAa2reteProcedure(DataSource dataSource) {
        ...
        declareParameter(new SqlOutParameter("P_RETCOD", Types.INTEGER));
     ...
     */
    public int execute(Aa2rete aa2rete, AuthorizationData authorizationData) throws GpffDaoException {
        ...
        try {
            ...
            return (Integer) maps.get("P_RETCOD");
        } catch (Exception e) {
