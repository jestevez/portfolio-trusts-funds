...
/**
 * The Class CreateAa2mcliProcedure.
 *
 ...
 */
@Service
public class CreateAa2mcliProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateAa2mcli";

    /**
     * Instantiates a new creates the aa 2 mcli procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateAa2mcliProcedure(DataSource dataSource) {
        ...
        declareParameter(new SqlOutParameter("P_CLICLA", Types.BIGINT));
    ...
    public int execute(Aa2mcli aa2mcli, AuthorizationData authorizationData) throws Exception {
        ...
        try {
            ...
            int msgcode = (Integer) maps.get("P_MSGCODE");
            return msgcode;
        } catch (Exception e) {
