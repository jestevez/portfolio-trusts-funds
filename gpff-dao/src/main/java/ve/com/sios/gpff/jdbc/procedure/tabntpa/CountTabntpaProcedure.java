...
/**
 * The Class CountTabntpaProcedure.
 *
 ...
 */
@Service
public class CountTabntpaProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountTabntpa";

    /**
     * Instantiates a new count tabntpa procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountTabntpaProcedure(DataSource dataSource) {
