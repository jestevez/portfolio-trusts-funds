...
/**
 * The Class CountOficinasProcedure.
 *
 ...
 */
@Service
public class CountOficinasProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountOficinas";

    /**
     * Instantiates a new count oficinas procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountOficinasProcedure(DataSource dataSource) {
