...
/**
 * The Class CreateAuxcontProcedure.
 *
 ...
 */
@Service
public class CreateAuxcontProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateAuxcont";

    /**
     * Instantiates a new creates the auxcont procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateAuxcontProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Auxcont auxcont, AuthorizationData authorizationData) throws Exception {
