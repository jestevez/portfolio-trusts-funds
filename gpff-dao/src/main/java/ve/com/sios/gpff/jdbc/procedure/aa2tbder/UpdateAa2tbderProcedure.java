...
/**
 * The Class UpdateAa2tbderProcedure.
 *
 ...
 */
@Service
public class UpdateAa2tbderProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateAa2tbder";

    /**
     * Instantiates a new update aa 2 tbder procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateAa2tbderProcedure(DataSource dataSource) {
