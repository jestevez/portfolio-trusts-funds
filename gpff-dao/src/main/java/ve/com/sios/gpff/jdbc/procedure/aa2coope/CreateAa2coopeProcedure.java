...
/**
 * The Class CreateAa2coopeProcedure.
 *
 ...
 */
@Service
public class CreateAa2coopeProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateAa2coope";

    /**
     * Instantiates a new creates the aa 2 coope procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateAa2coopeProcedure(DataSource dataSource) {
        ...
        declareParameter(new SqlOutParameter("P_COPCTR", Types.INTEGER));
     ...
     */
    public int execute(Aa2coope aa2coope, AuthorizationData authorizationData) throws Exception {
        ...
        try {
            ...
            return (Integer) maps.get("P_COPCTR");
        } catch (Exception e) {
