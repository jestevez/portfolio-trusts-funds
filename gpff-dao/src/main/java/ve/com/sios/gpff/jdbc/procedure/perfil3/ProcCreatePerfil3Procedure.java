/*
 * ProcCreatePerfil3Procedure.java
 *
 ...
 */
@Service
public class ProcCreatePerfil3Procedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "ProcCreatePerfil3";

    /**
     * Instantiates a new proc create perfil 3 procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public ProcCreatePerfil3Procedure(DataSource dataSource) {
