...
/**
 * The Class CreateApoderadProcedure.
 *
 ...
 */
@Service
public class CreateApoderadProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateApoderad";

    /**
     * Instantiates a new creates the apoderad procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateApoderadProcedure(DataSource dataSource) {
