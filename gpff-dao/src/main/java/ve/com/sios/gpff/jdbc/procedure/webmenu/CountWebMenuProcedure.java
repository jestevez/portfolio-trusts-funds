...
/**
 * The Class CountWebMenuProcedure.
 *
 ...
 */
@Service
public class CountWebMenuProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountWebMenu";

    /**
     * Instantiates a new count web menu procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountWebMenuProcedure(DataSource dataSource) {
     ...
     */
    public int execute(WebMenu webMenu, AuthorizationData authorizationData) throws GpffDaoException {
