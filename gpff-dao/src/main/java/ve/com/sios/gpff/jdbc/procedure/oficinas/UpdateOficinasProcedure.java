...
/**
 * The Class UpdateOficinasProcedure.
 *
 ...
 */
@Service
public class UpdateOficinasProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateOficinas";

    /**
     * Instantiates a new update oficinas procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateOficinasProcedure(DataSource dataSource) {
