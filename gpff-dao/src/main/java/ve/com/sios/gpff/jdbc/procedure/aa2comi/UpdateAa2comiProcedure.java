...
/**
 * The Class UpdateAa2comiProcedure.
 *
 ...
 */
@Service
public class UpdateAa2comiProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateAa2comi";

    /**
     * Instantiates a new update aa 2 comi procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateAa2comiProcedure(DataSource dataSource) {
