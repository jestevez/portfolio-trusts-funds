...
/**
 * The Class DeleteAa2copoProcedure.
 *
 ...
 */
@Service
public class DeleteAa2copoProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procDeleteAa2copo";

    /**
     * Instantiates a new delete aa 2 copo procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public DeleteAa2copoProcedure(DataSource dataSource) {
