...
/**
 * The Class UpdateAa2tgruProcedure.
 *
 ...
 */
@Service
public class UpdateAa2tgruProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateAa2tgru";

    /**
     * Instantiates a new update aa 2 tgru procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateAa2tgruProcedure(DataSource dataSource) {
