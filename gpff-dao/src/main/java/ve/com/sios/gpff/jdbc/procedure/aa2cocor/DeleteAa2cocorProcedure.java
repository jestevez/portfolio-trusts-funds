...
/**
 * The Class DeleteAa2cocorProcedure.
 *
 ...
 */
@Service
public class DeleteAa2cocorProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procDeleteAa2cocor";

    /**
     * Instantiates a new delete aa 2 cocor procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public DeleteAa2cocorProcedure(DataSource dataSource) {
