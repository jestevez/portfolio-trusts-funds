...
/**
 * The Class CountAa2tgruProcedure.
 *
 ...
 */
@Service
public class CountAa2tgruProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountAa2tgru";

    /**
     * Instantiates a new count aa 2 tgru procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountAa2tgruProcedure(DataSource dataSource) {
