...
/**
 * The Class DeleteAa2tprclProcedure.
 *
 ...
 */
@Service
public class DeleteAa2tprclProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procDeleteAa2tprcl";

    /**
     * Instantiates a new delete aa 2 tprcl procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public DeleteAa2tprclProcedure(DataSource dataSource) {
