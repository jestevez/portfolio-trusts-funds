...
/**
 * The Class CreateAa2tdivProcedure.
 *
 ...
 */
@Service
public class CreateAa2tdivProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateAa2tdiv";

    /**
     * Instantiates a new creates the aa 2 tdiv procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateAa2tdivProcedure(DataSource dataSource) {
        ...
        declareParameter(new SqlOutParameter("P_DIVCLA", Types.INTEGER));
     ...
     */
    public int execute(Aa2tdiv aa2tdiv, AuthorizationData authorizationData) throws Exception {
        ...
        try {
            ...
            return (Integer) maps.get("P_DIVCLA");
        } catch (Exception e) {
