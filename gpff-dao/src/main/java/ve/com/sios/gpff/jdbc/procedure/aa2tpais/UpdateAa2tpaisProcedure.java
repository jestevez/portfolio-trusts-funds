...
/**
 * The Class UpdateAa2tpaisProcedure.
 *
 ...
 */
@Service
public class UpdateAa2tpaisProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateAa2tpais";

    /**
     * Instantiates a new update aa 2 tpais procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateAa2tpaisProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Aa2tpais aa2tpais, AuthorizationData authorizationData) throws GpffDaoException {
