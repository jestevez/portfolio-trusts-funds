...
/**
 * The Class CountAa2atohProcedure.
 *
 ...
 */
@Service
public class CountAa2atohProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountAa2atoh";

    /**
     * Instantiates a new count aa 2 atoh procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountAa2atohProcedure(DataSource dataSource) {
