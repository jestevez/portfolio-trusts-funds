 ...
 */
@Service
public class ReadInversProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procReadInvers";

    /**
     * Instantiates a new read invers procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public ReadInversProcedure(DataSource dataSource) {
        ...
        declareParameter(new SqlReturnResultSet("RS", new InversMapper()));
     ...
     */
    public List execute(Invers invers, int firstResult, int maxResults, String sortClause, AuthorizationData authorizationData) throws GpffDaoException {
        ...
        inParams.put("P_ROWID", invers.getRowid());
...
class InversMapper implements RowMapper<Invers> {

    public Invers mapRow(ResultSet rs, int i) throws SQLException {
        Invers invers = new Invers();
        invers.setRowid(rs.getLong("ROWID"));
        invers.setInvemp(rs.getString("INVEMP"));
        invers.setInvdel(rs.getString("INVDEL"));
        invers.setInvcli(rs.getLong("INVCLI"));
        invers.setInvval(rs.getString("INVVAL"));
        invers.setInvint(rs.getLong("INVINT"));
        invers.setInvcla(rs.getString("INVCLA"));
        invers.setInvven(rs.getString("INVVEN"));
        invers.setInvine(rs.getLong("INVINE"));
        invers.setInvvte(rs.getLong("INVVTE"));
        invers.setInvpre(rs.getDouble("INVPRE"));
        invers.setInvini(rs.getLong("INVINI"));
        invers.setInvina(rs.getLong("INVINA"));
        invers.setInvvto(rs.getLong("INVVTO"));
        invers.setInvvta(rs.getLong("INVVTA"));
        invers.setInvefi(rs.getDouble("INVEFI"));
        invers.setInveff(rs.getDouble("INVEFF"));
        invers.setInvprc(rs.getDouble("INVPRC"));
        invers.setInv036(rs.getString("INV036"));
        invers.setInvtit(rs.getDouble("INVTIT"));
        invers.setInvpme(rs.getDouble("INVPME"));
        invers.setInvpin(rs.getDouble("INVPIN"));
        invers.setInvinf(rs.getDouble("INVINF"));
        invers.setInvrde(rs.getString("INVRDE"));
        invers.setInvlis(rs.getString("INVLIS"));
        invers.setInvanu(rs.getString("INVANU"));
        invers.setInvsir(rs.getString("INVSIR"));
        invers.setInvico(rs.getDouble("INVICO"));
        invers.setInvnop(rs.getLong("INVNOP"));
        invers.setInvper(rs.getInt("INVPER"));
        invers.setInvfde(rs.getDouble("INVFDE"));
        invers.setInvfui(rs.getLong("INVFUI"));
        invers.setInvnti(rs.getLong("INVNTI"));
        invers.setInvapr(rs.getDouble("INVAPR"));
        invers.setInvibs(rs.getString("INVIBS"));
        invers.setInvigc(rs.getDouble("INVIGC"));
        invers.setInvagd(rs.getDouble("INVAGD"));
        invers.setInvbvi(rs.getLong("INVBVI"));
        invers.setInvmar(rs.getDouble("INVMAR"));
        invers.setInvta1(rs.getString("INVTA1"));
        invers.setInvta2(rs.getDouble("INVTA2"));
        invers.setInvian(rs.getDouble("INVIAN"));
        invers.setInvbol(rs.getString("INVBOL"));
        invers.setInvipp(rs.getString("INVIPP"));
        invers.setInvvfv(rs.getString("INVVFV"));
        invers.setInvpro(rs.getInt("INVPRO"));
        invers.setInvpen(rs.getDouble("INVPEN"));
        invers.setInvprx(rs.getDouble("INVPRX"));
        invers.setInvvac(rs.getString("INVVAC"));
        invers.setInvnuc(rs.getLong("INVNUC"));
        invers.setInvpop(rs.getDouble("INVPOP"));
        invers.setInvbad(rs.getInt("INVBAD"));
        invers.setInvvno(rs.getDouble("INVVNO"));
        invers.setInvliq(rs.getLong("INVLIQ"));
        invers.setInvres(rs.getDouble("INVRES"));
        invers.setInvtim(rs.getDouble("INVTIM"));
