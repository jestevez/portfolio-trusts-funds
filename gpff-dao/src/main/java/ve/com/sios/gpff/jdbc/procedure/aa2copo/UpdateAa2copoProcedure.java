...
/**
 * The Class UpdateAa2copoProcedure.
 *
 ...
 */
@Service
public class UpdateAa2copoProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateAa2copo";

    /**
     * Instantiates a new update aa 2 copo procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateAa2copoProcedure(DataSource dataSource) {
