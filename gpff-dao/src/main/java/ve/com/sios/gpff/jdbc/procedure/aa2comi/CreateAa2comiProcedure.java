...
/**
 * The Class CreateAa2comiProcedure.
 *
 ...
 */
@Service
public class CreateAa2comiProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateAa2comi";

    /**
     * Instantiates a new creates the aa 2 comi procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateAa2comiProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Aa2comi aa2comi, AuthorizationData authorizationData) throws GpffDaoException {
