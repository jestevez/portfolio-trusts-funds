...
/**
 * The Class CountAa2tautProcedure.
 *
 ...
 */
@Service
public class CountAa2tautProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountAa2taut";

    /**
     * Instantiates a new count aa 2 taut procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountAa2tautProcedure(DataSource dataSource) {
