...
/**
 * The Class CountCgmaxminProcedure.
 *
 ...
 */
@Service
public class CountCgmaxminProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountCgmaxmin";

    /**
     * Instantiates a new count cgmaxmin procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountCgmaxminProcedure(DataSource dataSource) {
