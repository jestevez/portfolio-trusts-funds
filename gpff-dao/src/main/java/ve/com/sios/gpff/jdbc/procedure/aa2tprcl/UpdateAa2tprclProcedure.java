...
/**
 * The Class UpdateAa2tprclProcedure.
 *
 ...
 */
@Service
public class UpdateAa2tprclProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateAa2tprcl";

    /**
     * Instantiates a new update aa 2 tprcl procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateAa2tprclProcedure(DataSource dataSource) {
