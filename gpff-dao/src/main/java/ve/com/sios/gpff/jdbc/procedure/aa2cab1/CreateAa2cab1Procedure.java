...
/**
 * The Class CreateAa2cab1Procedure.
 *
 ...
 */
@Service
public class CreateAa2cab1Procedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateAa2cab1";

    /**
     * Instantiates a new creates the aa 2 cab 1 procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateAa2cab1Procedure(DataSource dataSource) {
     ...
     */
    public int execute(Aa2cab1 aa2cab1, AuthorizationData authorizationData) throws GpffDaoException {
