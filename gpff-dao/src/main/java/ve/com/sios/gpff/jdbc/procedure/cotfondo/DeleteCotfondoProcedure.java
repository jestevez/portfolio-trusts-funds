...
/**
 * The Class DeleteCotfondoProcedure.
 *
 ...
 */
@Service
public class DeleteCotfondoProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procDeleteCotfondo";

    /**
     * Instantiates a new delete cotfondo procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public DeleteCotfondoProcedure(DataSource dataSource) {
