...
/**
 * The Class CountMsgcodeProcedure.
 *
 ...
 */
@Service
public class CountMsgcodeProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountMsgcode";

    /**
     * Instantiates a new count msgcode procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountMsgcodeProcedure(DataSource dataSource) {
