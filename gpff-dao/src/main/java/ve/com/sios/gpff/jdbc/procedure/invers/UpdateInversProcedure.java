...
/**
 * The Class UpdateInversProcedure.
 *
 ...
 */
@Service
public class UpdateInversProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateInvers";

    /**
     * Instantiates a new update invers procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateInversProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Invers invers, AuthorizationData authorizationData) throws GpffDaoException {
