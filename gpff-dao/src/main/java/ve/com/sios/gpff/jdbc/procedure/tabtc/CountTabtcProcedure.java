 ...
 */
@Service
public class CountTabtcProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountTabtc";

    /**
     * Instantiates a new count tabtc procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountTabtcProcedure(DataSource dataSource) {
