...
/**
 * The Class CreateFctlconProcedure.
 *
 ...
 */
@Service
public class CreateFctlconProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateFctlcon";

    /**
     * Instantiates a new creates the fctlcon procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateFctlconProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Fctlcon fctlcon, AuthorizationData authorizationData) throws GpffDaoException {
