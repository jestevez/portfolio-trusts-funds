...
/**
 * The Class CountAa2tespProcedure.
 *
 ...
 */
@Service
public class CountAa2tespProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountAa2tesp";

    /**
     * Instantiates a new count aa 2 tesp procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountAa2tespProcedure(DataSource dataSource) {
