...
/**
 * The Class UpdateAa2tpdtoProcedure.
 *
 ...
 */
@Service
public class UpdateAa2tpdtoProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateAa2tpdto";

    /**
     * Instantiates a new update aa 2 tpdto procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateAa2tpdtoProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Aa2tpdto aa2tpdto, AuthorizationData authorizationData) throws Exception {
