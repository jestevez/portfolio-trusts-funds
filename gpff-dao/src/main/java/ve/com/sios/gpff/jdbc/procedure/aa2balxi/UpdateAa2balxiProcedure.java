...
/**
 * The Class UpdateAa2balxiProcedure.
 *
 ...
 */
@Service
public class UpdateAa2balxiProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateAa2balxi";

    /**
     * Instantiates a new update aa 2 balxi procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateAa2balxiProcedure(DataSource dataSource) {
