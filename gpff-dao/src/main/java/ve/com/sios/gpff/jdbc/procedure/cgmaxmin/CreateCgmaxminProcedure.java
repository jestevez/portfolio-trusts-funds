...
/**
 * The Class CreateCgmaxminProcedure.
 *
 ...
 */
@Service
public class CreateCgmaxminProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateCgmaxmin";

    /**
     * Instantiates a new creates the cgmaxmin procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateCgmaxminProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Cgmaxmin cgmaxmin, AuthorizationData authorizationData) throws Exception {
