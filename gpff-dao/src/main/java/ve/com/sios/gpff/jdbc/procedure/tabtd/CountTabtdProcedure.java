 ...
 */
@Service
public class CountTabtdProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountTabtd";

    /**
     * Instantiates a new count tabtd procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountTabtdProcedure(DataSource dataSource) {
