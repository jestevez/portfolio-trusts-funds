...
/**
 * The Class CountGroupByAa2coopeProcedure.
 *
 ...
 */
@Service
public class CountGroupByAa2coopeProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountGroupByAa2coope";

    /**
     * Instantiates a new count group by aa 2 coope procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountGroupByAa2coopeProcedure(DataSource dataSource) {
