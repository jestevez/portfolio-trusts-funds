...
/**
 * The Class UpdatePerfilProcedure.
 *
 ...
 */
@Service
public class UpdatePerfilProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdatePerfil";

    /**
     * Instantiates a new update perfil procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdatePerfilProcedure(DataSource dataSource) {
