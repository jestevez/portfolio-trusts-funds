...
/**
 * The Class DeleteAa2procoProcedure.
 *
 ...
 */
@Service
public class DeleteAa2procoProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procDeleteAa2proco";

    /**
     * Instantiates a new delete aa 2 proco procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public DeleteAa2procoProcedure(DataSource dataSource) {
