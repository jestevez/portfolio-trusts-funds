...
/**
 * The Class DeleteTableHelpProcedure.
 *
 ...
 */
@Service
public class DeleteTableHelpProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procDeleteTableHelp";

    /**
     * Instantiates a new delete table help procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public DeleteTableHelpProcedure(DataSource dataSource) {
     ...
     */
    public boolean execute(TableHelp tableHelp, AuthorizationData authorizationData) throws Exception {
