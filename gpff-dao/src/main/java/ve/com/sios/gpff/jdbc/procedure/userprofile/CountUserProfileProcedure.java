/*
 * CountUserProfileProcedure.java
 *
...
/**
 * The Class CountUserProfileProcedure.
 *
 ...
 */
@Service
public class CountUserProfileProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountUserProfile";

    /**
     * Instantiates a new count user profile procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountUserProfileProcedure(DataSource dataSource) {
     ...
     */
    public int execute(UserProfile userProfile, AuthorizationData authorizationData) throws GpffDaoException {
