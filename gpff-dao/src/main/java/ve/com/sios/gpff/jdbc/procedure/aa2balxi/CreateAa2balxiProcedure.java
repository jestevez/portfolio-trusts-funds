...
/**
 * The Class CreateAa2balxiProcedure.
 *
 ...
 */
@Service
public class CreateAa2balxiProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateAa2balxi";

    /**
     * Instantiates a new creates the aa 2 balxi procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateAa2balxiProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Aa2balxi aa2balxi, AuthorizationData authorizationData) throws GpffDaoException {
