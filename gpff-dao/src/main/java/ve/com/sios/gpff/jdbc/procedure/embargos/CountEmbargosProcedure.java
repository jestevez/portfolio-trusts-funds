...
/**
 * The Class CountEmbargosProcedure.
 *
 ...
 */
@Service
public class CountEmbargosProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCountEmbargos";

    /**
     * Instantiates a new count embargos procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CountEmbargosProcedure(DataSource dataSource) {
