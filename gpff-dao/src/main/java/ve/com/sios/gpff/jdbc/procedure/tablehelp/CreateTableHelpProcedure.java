...
/**
 * The Class CreateTableHelpProcedure.
 *
 ...
 */
@Service
public class CreateTableHelpProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procCreateTableHelp";

    /**
     * Instantiates a new creates the table help procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public CreateTableHelpProcedure(DataSource dataSource) {
     ...
     */
    public int execute(TableHelp tableHelp, AuthorizationData authorizationData) throws GpffDaoException {
