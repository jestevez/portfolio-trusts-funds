...
/**
 * The Class UpdateTabtaProcedure.
 *
 ...
 */
@Service
public class UpdateTabtaProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateTabta";

    /**
     * Instantiates a new update tabta procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateTabtaProcedure(DataSource dataSource) {
