...
/**
 * The Class UpdateTabtrProcedure.
 *
 ...
 */
@Service
public class UpdateTabtrProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateTabtr";

    /**
     * Instantiates a new update tabtr procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateTabtrProcedure(DataSource dataSource) {
