...
/**
 * The Class UpdateAa2gestoProcedure.
 *
 ...
 */
@Service
public class UpdateAa2gestoProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateAa2gesto";

    /**
     * Instantiates a new update aa 2 gesto procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateAa2gestoProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Aa2gesto aa2gesto, AuthorizationData authorizationData) throws GpffDaoException {
