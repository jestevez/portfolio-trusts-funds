...
/**
 * The Class UpdateAa2tdivProcedure.
 *
 ...
 */
@Service
public class UpdateAa2tdivProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateAa2tdiv";

    /**
     * Instantiates a new update aa 2 tdiv procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateAa2tdivProcedure(DataSource dataSource) {
