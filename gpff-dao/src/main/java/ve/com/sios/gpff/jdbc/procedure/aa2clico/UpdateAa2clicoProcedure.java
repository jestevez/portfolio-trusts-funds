...
/**
 * The Class UpdateAa2clicoProcedure.
 *
 ...
 */
@Service
public class UpdateAa2clicoProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procUpdateAa2clico";

    /**
     * Instantiates a new update aa 2 clico procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public UpdateAa2clicoProcedure(DataSource dataSource) {
     ...
     */
    public int execute(Aa2clico aa2clico, AuthorizationData authorizationData) throws GpffDaoException {
