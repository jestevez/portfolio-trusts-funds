...
/**
 * The Class DeleteAa2emisoProcedure.
 *
 ...
 */
@Service
public class DeleteAa2emisoProcedure extends StoredProcedure {

    /** The Constant SP_NAME. */
    private static final String SP_NAME = "procDeleteAa2emiso";

    /**
     * Instantiates a new delete aa 2 emiso procedure.
     *
     * @param dataSource the data source
     */
    @Autowired
    public DeleteAa2emisoProcedure(DataSource dataSource) {
