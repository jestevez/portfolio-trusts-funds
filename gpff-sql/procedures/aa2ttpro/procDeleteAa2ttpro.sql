...
--DROP PROCEDURE GPSQLWEB.procDeleteAa2ttpro

CREATE PROCEDURE GPSQLWEB.procDeleteAa2ttpro (
    IN P_ROWID BIGINT,
...
SET P_MSGCODE = 9999;
  ...
  IF V_CANT > 1 THEN
	SET P_MSGCODE = 9001;
        ...
        CALL GPSQLWEB.procCreateWebAudit (P_IPADDRESS, P_USERAGENT, P_USERNAME, 'Eliminar', 'procDeleteAa2ttpro', StringSQL);
        RETURN;
  END IF;
  ...
  DELETE FROM GPDATWEB.AA2TTPRO WHERE RRN(GPDATWEB.AA2TTPRO) = P_ROWID;
  
  Set StringSQL = 'DELETE FROM GPDATWEB.AA2TTPRO WHERE RRN(GPDATWEB.AA2TTPRO) = '''|| P_ROWID || ''';';
  CALL GPSQLWEB.procCreateWebAudit (P_IPADDRESS, P_USERAGENT, P_USERNAME, 'Eliminar', 'procDeleteAa2ttpro', StringSQL);
