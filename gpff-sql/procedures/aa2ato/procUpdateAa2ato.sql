-- DROP PROCEDURE GPSQLWEB.procUpdateAa2ato
    
CREATE PROCEDURE GPSQLWEB.procUpdateAa2ato
(
    IN P_ROWID BIGINT,
...
BEGIN
  ...
  SELECT COUNT(1) INTO V_CANT FROM GPDATWEB.AA2ATO WHERE RRN(GPDATWEB.AA2ATO) = P_ROWID;

  IF V_CANT > 0 THEN
	SET P_MSGCODE = 9001;
        SET StringSQL = '9001 - HAY MAS DE UN REGISTRO CON LA CLAVE PRIMARIA';
        CALL GPSQLWEB.procCreateWebAudit (P_IPADDRESS, P_USERAGENT, P_USERNAME, 'Actualizar', 'procUpdateAa2ato', StringSQL);
        RETURN;
  END IF;
